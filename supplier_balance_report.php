	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-12">
					<h2 class="font-weight-bold"><span class="en">Supplier Balance Statement</span><span class="ar"><?= getArabicTitle('Supplier Balance Statement') ?></span></h2>
			...
			<div class="wrapper wrapper-content animated fadeInRight">
										...
										<div class="row">
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input type="checkbox" id="branch_all_select_1" name="branch_all_select" <?php if ($_GET['branch_all_select'] == 'on') {echo "checked";} ?> class="js-switch" />
												</div>
											</div>
											<div class="col-md-8">
												<div class="form-group">
				...
				?>
					<div class="ibox">
						<h2><span class="en float-left">Supplier Balance Statement</span><span class="ar float-right"><?= getArabicTitle('Supplier Balance Statement') ?></span></h2>
							...
							<div class="table-responsive">
								...
								<div class="row">
									<div class="col-lg-12" id="sales_report">
										...
										$mainStoreProcedure = "EXEC  " . dbObject . "GetSupplierBalalance   @bid='" . $bid . "',@dt='" . $dt . "',@dt2='" . $dt2 . "',@Cids='" . $Cids . "',@LanguageId ='" . $LanguageId . "',@IsIncludingZeroBal ='" . $IsIncludingZeroBal . "',@OrderBy ='" . $OrderBy . "'";
										...
										<div class="col-md-12 col-sm-12 col-lg-12 mb-4 text-center">
											<div class="d-grid gap-2 col-12 pl-0">
												<button style="width: 130px;" type="button" class="btn btn-w-m btn-outline-primary" id="reportPRint" onclick="PrintPopup('<?= $print ?>', 'Supplier Balance Report', 'SupplierBalance')"><i class="fa fa-print" aria-hidden="true"></i></button>
											</div>
										</div>
										<hr>
										<!-- Listing -->
										<table class="table table-striped table-bordered dt-responsive table-hover ">
											<thead>
												<tr>
													<th><span class="en">Supplier Code</span><span class="ar"><?= getArabicTitle('Supplier Code') ?></span></th>
													<th><span class="en">Supplier Name</span><span class="ar"><?= getArabicTitle('Supplier Name') ?></span></th>
...
<script>
	...
	$("#branch_all_select_1").on('change', function() {
		if ($(this).is(':checked')) {
