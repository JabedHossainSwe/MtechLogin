	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Purchase Return Report (General)</span><span class="ar"><?= getArabicTitle('Purchase Return Report (General)') ?></span></h2>
				</div>
				<div class="col-lg-2">
					...
					<div class="col-lg-12">
						<div class="ibox">
							<div class="ibox-title">
								<div class="row">
									<!-- <div class="col-md-9"> -->
										<h5 class="mr-4"><span class="en float-right">Filters</span><span class="ar float-right">
												<?= getArabicTitle('Filters') ?>
											</span></h5>
									<!-- </div> -->
							...
							<form action="" id="" method="get" class="ibox-content  filter_container">
								...
								<div class="row">
									...
									<div class="col-md-6 pt-2 toggle_orderby">
										<div class="row">
											<div class="col-md-4">
												<h4><span class="en">Is Vat On Invoice</span><span class="ar">
														<?= getArabicTitle('Is Vat On Invoice') ?>
													</span>
												</h4>
											</div>
											<div class="col-md-8">
													...
													<div class="col-md-3 col-6">
														<div class="i-checks"><label class="">
																<div class="iradio_square-green ">
																	...
																	<ins class="iCheck-helper"></ins>
																</div> <i></i> <span class="en">0</span><span class="ar">
																	<?= getArabicTitle('0') ?>
																</span>
															</label>
														</div>
													...
													<div class="col-md-3 col-6">
														<div class="i-checks"><label class="">
																<div class="iradio_square-green ">
																	...
																	<ins class="iCheck-helper"></ins>
																</div> <i></i> <span class="en">1</span><span class="ar">
																	<?= getArabicTitle('1') ?>
																</span>
															</label>
														</div>
													...
													<div class="col-md-4 col-6">
														<div class="i-checks"><label class="">
																<div class="iradio_square-green ">
																	...
																	<ins class="iCheck-helper"></ins>
																</div> <i></i> <span class="en">Group by Supplier </span><span class="ar">
																	<?= getArabicTitle('Group by Supplier') ?>
																</span>
															</label>
														</div>
													</div>
													<div class="col-md-4 col-6">
														<div class="i-checks"><label class="">
																<div class="iradio_square-green ">
																	...
																	<ins class="iCheck-helper"></ins>
																</div> <i></i> <span class="en">Group by Bill Date</span><span class="ar">
																	<?= getArabicTitle('Group by Bill Date') ?>
																</span>
															</label>
														</div>
													</div>
...
//////////////// Branches Filter//////////////
										...
										if ($_GET['GroupByType'] == '') {
											$GroupByType = 0;
											include("include/reports/purchase/purchase_return_general/groupbynone.php");
										}


										if ($_GET['GroupByType'] == '1') {
											$GroupByType = 1;
											include("include/reports/purchase/purchase_return_general/groupbysupplier.php");
										}
										...
										if ($_GET['GroupByType'] == '2') {
											$GroupByType = 2;
											include("include/reports/purchase/purchase_return_general/groupbybilldate.php");
										}
