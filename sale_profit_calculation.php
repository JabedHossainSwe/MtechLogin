...
<div class="col-lg-12">
<h2 class="font-weight-bold"><span class="en float-left">Sale Profit Calculation</span><span class="ar float-right"><?= getArabicTitle('Sale Profit Calculation') ?></span></h2>
...
<div class="row">
<div class="col-md-4">
<h4><span class="en">Sales Man</span><span class="ar">
<?= getArabicTitle('Sales Man') ?>
</span></h4>
</div>
<div class="col-md-2 col-4">
<div class="form-group">
...
<div class="iradio_square-green">
<input type="radio" <?php if ($_GET['rpttyp'] == 'general' || $_GET['rpttyp'] == '') {
echo 'checked="checked"';
} ?> value="general" name="rpttyp">
</div>
...
<div class="iradio_square-green ">
<div class="iradio_square-green">
<input type="radio" value="detail" name="rpttyp" <?php if ($_GET['rpttyp'] == 'detail') {
echo 'checked="checked"';
} ?>>
</div>
<ins class="iCheck-helper"></ins>
...
<div class="iradio_square-green ">
<div class="iradio_square-green">
<input type="radio" value="1" <?php if ($_GET['SpType'] == '1') {
echo "Checked";
} ?>
name="SpType">
</div>
...
<div class="iradio_square-green ">
<div class="iradio_square-green">
<input type="radio" value="2" name="SpType" <?php if ($_GET['SpType'] == '2') {
echo "Checked";
} ?>>
</div>
<ins class="iCheck-helper"></ins>
...
<div class="iradio_square-green ">
<div class="iradio_square-green">
<input type="radio" value="0" name="SpType" <?php if ($_GET['SpType'] == '0' || $_GET['SpType'] == '') {
echo "Checked";
} ?>>
</div>
<ins class="iCheck-helper"></ins>
</div> <i></i> <span class="en">Both</span><span class="ar"><?= getArabicTitle('Both') ?></span>
</label>
</div>
</div>
</div>
...
?>
<div class="ibox">
<h2><span class="en float-left">Sale Profit Calculation</span><span class="ar float-right"><?= getArabicTitle('Sale Profit Calculation') ?></span></h2>
...
$SpType = !empty($_GET['SpType']) ? $_GET['SpType'] : '0';
$rpttyp = !empty($_GET['rpttyp']) ? $_GET['rpttyp'] : 'general';


$pages = new Paginator;
if ($rpttyp == 'general') {

include("include/reports/sale_profit_calculation/general.php");

}
if ($rpttyp == 'detail') {

include("include/reports/sale_profit_calculation/detail.php");
...
<script src="include/reports/sale_profit_calculation/js.js"></script>
<?php
if (isset($_GET['report_type']) && $_GET['report_type'] == 'general') {
?>
<script>
