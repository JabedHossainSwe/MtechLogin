...
<div class="col-lg-4">
<h2 class="font-weight-bold"><span class="en">Purchase Report (General)</span><span class="ar"><?= getArabicTitle('Purchase Report (General)') ?></span></h2>
</div>
<div class="col-lg-2">
<a href="purchase_report_general.php">
...
<div class="col-lg-2">
<a href="purchase_report_detail.php">
...
<div class="col-lg-2">
<a href="purchase_report_group.php">
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="row">
			<div class="col-md-4">
				<h4><span class="en">From Bill No</span><span class="ar"><?= getArabicTitle('From Bill No') ?></span></h4>
			</div>
			<div class="col-md-8">
				<div class="form-group">
	...
	<div class="col-6">
		<div class="row">
			...
			<div class="col-md-2 col-4">
				<div class="form-group">
					<input type="text" value="<?php echo $_GET['PurType'] ?>" id="PurType" name="PurType" readonly
						class="form-control">
				</div>
			</div>
			<div class="col-md-6 col-8">
				<div class="form-group">
					<div>
						<select id="PurName" name="PurName" class="select2_demo_1 form-control" tabindex="4"
							onChange="setmyValue(this.value,'PurType')">

							<?php
							if (isset($_GET['PurType']) && !empty($_GET['PurType'])) {
								?>
								<option value="<?php echo $_GET['PurType']; ?>" selected> <?php echo getUserDetails($_GET['user_id'])->CCode; ?>
									-
	...
	<div class="col-6">
		<div class="row">
			<div class="col-md-4">
				<h4><span class="en">Purchaser</span><span class="ar"><?= getArabicTitle('Purchaser') ?></span>
				</h4>
			</div>
			<div class="col-md-2 col-4">
				<div class="form-group"><input id="PurChaser" name="PurChaser" type="text" readonly
						class="form-control" value="<?php echo $_GET['PurChaser'] ?>">
				</div>
			</div>
			<div class="col-md-6 col-8">
				<div class="form-group">
					<div>
						<select id="PurChaser_Name" name="PurChaser_Name" class="select2_demo_1 form-control"
							tabindex="4" onChange="setmyValue(this.value,'PurChaser')">
							<?php
							if (isset($_GET['PurChaser']) && !empty($_GET['PurChaser'])) {
								?>
		...
		<div class="row">
			...
			<div class="col-md-2 col-4">
				<div class="form-group"><input id="customer_id" name="customer_id" type="text" readonly
						class="form-control" value="<?php echo $_GET['customer_id'] ?>">
				</div>
			</div>
			<div class="col-md-6 col-8">
				<div class="form-group">
	...
	<div class="col-md-6 pt-2 toggle_orderby">
		<div class="row">
			<div class="col-md-4">
				<h4><span class="en">Is Vat On Invoice</span><span class="ar"><?= getArabicTitle('Is Vat On Invoice') ?></span>
				</h4>
			</div>
			<div class="col-md-8">
				<div class="row">
					<div class="col-md-3 col-6">
						<div class="i-checks"><label class="">
								...
								<i></i> <span class="en">0</span><span class="ar"><?= getArabicTitle('0') ?></span>
							</label>
						</div>
					</div>
					<div class="col-md-3 col-6">
						<div class="i-checks"><label class="">
								...
								<i></i> <span class="en">1 </span><span class="ar"><?= getArabicTitle('1') ?></span>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3 col-6">
						<div class="i-checks"><label class="">
								...
								<i></i> <span class="en">Group By None</span><span class="ar"><?= getArabicTitle('Group By None') ?></span>
							</label>
						</div>
					</div>
					<div class="col-md-3 col-6">
						<div class="i-checks"><label class="">
								...
								<i></i> <span class="en">Group by Supplier</span><span class="ar"><?= getArabicTitle('Group by Supplier') ?></span>
							</label>
						</div>
					</div>
					<div class="col-md-3 col-6">
						<div class="i-checks"><label class="">
								...
								<i></i> <span class="en">Group by Bill Date</span><span class="ar"><?= getArabicTitle('Group by Bill Date') ?></span>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3 col-6">
						<div class="i-checks"><label class="">
								...
								<i></i> <span class="en">All</span><span class="ar"><?= getArabicTitle('All') ?></span>
							</label>
						</div>
					</div>
				</div>
...
?>
<div class="ibox">
<h2 class="en float-left">General</h2>
<h2 class="ar float-right"><?= getArabicTitle('General') ?></h2>
...
//////////////// Branches Filter//////////////
		...
		$IsNoVatOnInvoice = !empty($_REQUEST['IsNoVatOnInvoice']) ? $_REQUEST['IsNoVatOnInvoice'] : '0';
		...
		if ($_GET['GroupByType'] == '') {
			$GroupByType = 0;
			include("include/reports/purchase/purchase_general/groupbynone.php");
		}


		if ($_GET['GroupByType'] == '1') {
			$GroupByType = 1;
			include("include/reports/purchase/purchase_general/groupbysupplier.php");
		}


		if ($_GET['GroupByType'] == '2') {
			$GroupByType = 2;
			include("include/reports/purchase/purchase_general/groupbybilldate.php");
		}
