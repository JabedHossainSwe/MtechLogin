...
<div class="col-lg-4">
<h2 class="font-weight-bold"><span class="en">Sales Report (General) </span><span class="ar"><?= getArabicTitle('Sales Report (General)') ?></span></h2>
</div>
<div class="col-lg-2">
...
<div class="row">
	...
	<div class="col-6">
		<div class="row">
			...
			<div class="col-md-2 col-4">
				<div class="form-group"><input id="customer_id" name="customer_id" type="text" readonly class="form-control" value="<?php echo $_GET['customer_id'] ?>">
				</div>
			</div>
			...
			<div class="col-md-2 col-6">
				<div class="form-group">
					<select name="amount_type" id="amount_type" class="form-control">
						<option value="" class="en">--Select--</option>
						<option value="" class="ar"><?= getArabicTitle('--Select--') ?></option>
				...
				<div class="row">
					...
					<div class="col-md-3 col-6">
						<div class="i-checks"><label class="">
								...
								<i></i> <span class="en">Group by Customer </span><span class="ar"><?= getArabicTitle('Group by Customer') ?></span>
							</label>
						</div>
					</div>
					<div class="col-md-3 col-6">
	...
	<div class="col-12">
		<div class="row justify-content-center mt-5">
			<div class="col-md-2">
				<button type="button" class="btn btn-block btn-outline-danger" onClick="location.reload()"><span class="en">Exit</span><span class="ar"><?= getArabicTitle('Exit') ?></span>
				</button>
			</div>
			<div class="col-md-2">
				<button type="submit" class="filter btn btn-block btn-outline-success" id="seles_report_search" value="Search"><span class="en">Search</span><span class="ar"><?= getArabicTitle('Search') ?></span>
				</button>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-lg-12" id="sales_report">
		...
		if ($_GET['GroupByType'] == '') {
			$GroupByType = 0;
			include("include/reports/sales/sales_general/groupbynone.php");
		}

		if ($_GET['GroupByType'] == 'BillDate') {
			$GroupByType = 2;
			include("include/reports/sales/sales_general/groupbybilldate.php");
		}


		if ($_GET['GroupByType'] == 'CSID') {
			$GroupByType = 1;
			include("include/reports/sales/sales_general/groupbyCSID.php");
		}
