	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Vat Purchase Report</span><span class="ar"><?= getArabicTitle('Vat Purchase Report') ?></span></h2>
				</div>
								...
								<div class="col-6">
									...
									<div class="col-lg-6">
										<div class="row">
											...
											<div class="col-md-8">
												<div class="form-group">
													<div>
														<select id="supplier_name" name="supplier_name" class="select2_demo_1 form-control" tabindex="4">
															<?php
                                                            if (isset($_GET['supplier_name']) && !empty($_GET['supplier_name'])) {
                                                            ?>
                                                                <option value="<?php echo $_GET['supplier_name']; ?>" selected>
                                                                    <?php echo getSupplierDetails($_GET['supplier_name'])->CName; ?>
                                                                </option>
                                                            <?php
                                                            }
                                                            ?>
										...
										<div class="row">
											<div class="col-md-4 col-4">
												<div class="i-checks"><label class="">
														<div class="iradio_square-green ">
															<div class="iradio_square-green">
																<input type="radio" <?php if ($_GET['pay_type'] == '1') {echo "Checked";} ?> value="1" name="pay_type" required>
															</div>
											...
											<div class="col-md-4 col-4">
												<div class="i-checks"><label class="">
														<div class="iradio_square-green ">
															<div class="iradio_square-green">
																<input type="radio" value="2" name="pay_type" <?php if ($_GET['pay_type'] == '2') {echo "Checked";} ?> required>
															</div>
															<ins class="iCheck-helper"></ins>
											...
											<div class="col-md-4 col-4">
												<div class="i-checks"><label class="">
														<div class="iradio_square-green ">
															<div class="iradio_square-green">
																<input type="radio" value="0" name="pay_type" <?php if ($_GET['pay_type'] == '0') {echo "Checked";} elseif ($_GET['pay_type'] == '') {echo "Checked";} ?>  required>
															</div>
															<ins class="iCheck-helper"></ins>
														</div> <i></i> <span class="en">Both </span><span class="ar">
															<?= getArabicTitle('Both') ?>
														</span>
													</label>
												</div>
									...
									<div class="col-12 row justify-content-center mt-5">
										...
										<div class="col-md-2">
											...
											<input type="submit" class="btn btn-block btn-lg btn-outline-success en" name="submit" value="Search">
											<input type="submit" class="btn btn-block btn-lg btn-outline-success ar" name="submit" value="<?= getArabicTitle('Search') ?>">
										</div>
									</div>
								</div>
							</form>
							...
							<div class="table-responsive">
								...
								<div class="row">
									<div class="col-lg-12" id="sales_report">
										...
										if (isset($_GET['supplier_name']) && !empty($_GET['supplier_name'])) {
											$supplier_name = urldecode($_GET['supplier_name']);
										}
										
										if (isset($_GET['pay_type']) && !empty($_GET['pay_type'])) {
											$pay_type = urldecode($_GET['pay_type']);
										}
										...
										$supplier_name = !empty($supplier_name) ? $supplier_name : 0;

										$pages = new Paginator;

										include("include/reports/vat/vat_purchase_report/index.php");
