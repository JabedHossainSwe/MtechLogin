...
<body class="pace-done mini-navbar">
	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			$QueryMax = Run("Select max(BillNo) as Bno from " . dbObject . "OpeningQuantity $condition");
			...
			<div id="editVoucher">
				<form action="javascript:SaveQuantityVoucher()" id="sales_report_form" method="post" id="sales_voucher" class="ibox-content  filter_container">
									...
									<div class="row">
										<div class="col-4">
											<div class="row">
												...
												<div class="col-md-8">
													<select id="Bid" name="Bid" class="grpreq select2_demo_1 form-control" tabindex="4" required onchange="getBillNo(this.value)">
														<?php
										...
										<div class="col-4">
											<div class="row">
												...
												<div class="col-md-6">
													...
													<?php
													$qt = "select BillNo from OpeningQuantity where BillNo = (select max(BillNo) from OpeningQuantity where BillNo < '" . $getBillNo . "' and Bid='" . $bidValue . "' and isDeleted = 0) and Bid = '" . $bidValue . "' and isDeleted = 0";
										...
										<div class="col-4 text-center">
											<div class="i-checks"><label class="">
													<div class="iradio_square-green ">
														<div class="iradio_square-green">
															<input type="radio" value="1" class="isExp" name="isExp">
														</div>
...
<script src="vouchers/opening_quantity/js.js"></script>
