	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content animated fadeInRight">
				...
				?>
					<div class="ibox">
						<h2 class="en float-left">Customer Accout Statement</h2>
						<h2 class="ar float-right"><?= getArabicTitle('Customer Accout Statement') ?></h2>
											...
											<thead>
												<tr>
													<th>
														...
														<span class="en">Transaction Type</span><span class="ar"><?= getArabicTitle('Transaction Type') ?></span>
													</th>

													<th>

														<span class="en">Branch</span><span class="ar"><?= getArabicTitle('Branch') ?></span>
													</th>
													<th>
														<span class="en">BillNo</span><span class="ar"><?= getArabicTitle('BillNo') ?></span>
													</th>

													<th>
														<span class="en">Bill Date / Time</span><span class="ar"><?= getArabicTitle('Bill Date / Time') ?></span>
													</th>
													<th>
														<span class="en">Debit</span><span class="ar"><?= getArabicTitle('Debit') ?></span>
													</th>
													...
													<th>
														<span class="en">Balance</span><span class="ar"><?= getArabicTitle('Balance') ?></span>
													</th>
												</tr>
...
<?php
													...
													$DateValue = DateValue($single->BillDate/Time);
											?>

													<tr>
														<td><span class="text-warp"><?php echo $single->TrnsType; ?> </span></td>
														<td><span class="text-warp"><?php echo $single->Branch; ?> </span></td>
														<td><span class="text-warp"><?php echo $single->BillNo; ?> </span></td>
														<td><span class="text-warp"><?php echo $DateValue; ?> </span></td>
