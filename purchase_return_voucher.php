...
<body class="pace-done mini-navbar">
	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			$QueryMax = Run("Select max(Billno) as Bno from " . dbObject . "DataInReturn $condition");
			...
			<div class="wrapper wrapper-content animated fadeInRight">
				...
				<div id="editVoucher">
					<form action="javascript:SaveSalesVoucher()" id="sales_report_form" method="post" class="ibox-content direction">
						<div class="row">
							<div class="col-lg-12">
								<div class="ibox">
									<div class="ibox-title">
										<div class="row">
											<div class="col-md-12">
												<h5 class="mr-4 float-left en">Purchase Return Voucher</h5>
												<h5 class="mr-4 float-right ar"><?= getArabicTitle('Purchase Return Voucher') ?></h5>
											</div>
										</div>
									</div>
											...
											<div class="row">
												...
												<div class="col-md-8">
													<div class="form-group">
														<div>
															<select class="select2_demo_1 form-control" name="Bid" id="Bid" onChange="loadBanksagainstBrank(this.value)">
																<?php
...
where " . dbObject . "EMP.WebCode = '" . $_SESSION['code'] . "' ");
										...
										<div class="col-md-6 row">
											...
											<div class="col-6">
												...
												<?php
												$qt = "select BillNo from datainreturn where BillNo = (select max(BillNo) from datainreturn where BillNo < '" . $getBillNo . "' and Bid='" . $bidValue . "' and isDeleted = 0) and Bid = '" . $bidValue . "' and isDeleted = 0";
										...
										<div class="col-md-6">
											<div class="row">
												...
												<div class="col-md-2 pl-0">
													<div class="form-group"><input id="PurType" value="" name="PurType" type="text" class="form-control" value="" readonly></div>
												</div>
									...
									<div class="row">
										...
										<div class="col-md-4 row ">
											...
											<div class="col-md-2 pl-0">
												<div class="form-group"><input id="supplier_id" name="supplier_id" type="text" class="form-control text-center" value="" readonly></div>
											</div>
							...
							<div class="col-md-12" class="m-0" id="addRow" style="display:block; overflow-x:scroll;">
...
<script src="vouchers/purchasereturn/js.js"></script>
