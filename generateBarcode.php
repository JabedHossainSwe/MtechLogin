<?php
    ...
    while($getData = myfetch($execute)){
        ...
        //// Generate QR Code////
        $PNG_WEB_DIR = 'vouchers/salesreturn/QrCodes/';
        $PNG_TEMP_DIR = 'vouchers/salesreturn/QrCodes/';
    ...
    while($getData = myfetch($execute)){
        ...
        //// Generate QR Code////
        // sales return mtech
        $PNG_WEB_DIR = 'vouchers/sales/QrCodes/';
        $PNG_TEMP_DIR = 'vouchers/sales/QrCodes/';
