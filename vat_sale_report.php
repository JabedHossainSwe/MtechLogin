	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Vat Sale Report</span><span class="ar"><?= getArabicTitle('Vat Sale Report') ?></span></h2>
				</div>
														...
														<select id="customer_id" name="customer_id" class="select2_demo_1 form-control" tabindex="4">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $_GET['customer_id']; ?>" selected>
                                                                    <?php echo getCustomerDetails($_GET['customer_id'])->CName; ?>
                                                                </option>
                                                            <?php
                                                            }
                                                            ?>
							...
							<div class="table-responsive">
								...
								<div class="row">
									<div class="col-lg-12" id="sales_report">
										...
										include("include/reports/vat/vat_sale_report/index.php");
