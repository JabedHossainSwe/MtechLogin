...
if ($LanguageId == 1) {
	$html .= '<div id="Sale-Inovice" style="-webkit-print-color-adjust:exact !important;
		...
		<tr>
			...
			<th style="font-weight: 500;">Grand Total</th>		
			<th style="font-weight: 500;">Net Purchase Amount</th>	
	...
	while ($single = myfetch($detailsSp)) {
		...
		$NetPurchaseAmountTot = $NetPurchaseAmountTot + $single->NetPurchaseAmount;
		...
		<tr>
			...
			<th style="font-weight: 300;">' . AmountValue($single->NetPurchaseAmount) . '</th>
	...
	$html .= '
		<tr>
			...
			<th style="font-weight: 600;">' . AmountValue($NetPurchaseAmountTot) . '</th>
...
if ($LanguageId == 2) {
	...
	<table border="1" style="width: 100%; font-size: 1rem; border-collapse: collapse;">
		<tr>
			...
			<th style="font-weight: 500;">' . getArabicTitle('Grand Total') . '</th>		
			<th style="font-weight: 500;">' . getArabicTitle('Net Purchase Amount') . '</th>	
