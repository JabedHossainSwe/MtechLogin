...
function Print_report_details()
{
  ...
  if(group_by == 'expenseGeneralNone'){
    window.open(
    'include/reports/expense_report/general_print_none.php?query='+bill_query+'&LanguageId='+print_language+'&type='+bill_type+'','_blank' // <- This is what makes it open in a new window.
    );
  }
  else if(group_by == 'expenseGeneralExpense'){
    window.open(
    'include/reports/expense_report/general_print_expense.php?query='+bill_query+'&LanguageId='+print_language+'&type='+bill_type+'','_blank' // <- This is what makes it open in a new window.
    );
  }
  else if(group_by == 'expenseGeneralDate'){
    window.open(
    'include/reports/expense_report/general_print_date.php?query='+bill_query+'&LanguageId='+print_language+'&type='+bill_type+'','_blank' // <- This is what makes it open in a new window.
    );
  }
  else if(group_by == 'expenseDetailNone'){
    window.open(
    'include/reports/expense_report/detail_print_none.php?query='+bill_query+'&LanguageId='+print_language+'&type='+bill_type+'','_blank' // <- This is what makes it open in a new window.
    );
  }
  else if(group_by == 'expenseDetailExpense'){
    window.open(
    'include/reports/expense_report/detail_print_expense.php?query='+bill_query+'&LanguageId='+print_language+'&type='+bill_type+'','_blank' // <- This is what makes it open in a new window.
    );
  }
  else if(group_by == 'expenseDetailDate'){
    window.open(
    'include/reports/expense_report/detail_print_date.php?query='+bill_query+'&LanguageId='+print_language+'&type='+bill_type+'','_blank' // <- This is what makes it open in a new window.
    );
  }
