...
if ($LanguageId == 1) {
	...
	while ($single = myfetch($detailsSp)) {
		...
		$VatPerTot = $VatPerTot + $single->VatPer;
		...
		<tr>
			...
			<th style="font-weight: 300;">' . AmountValue($single->VatPer) . '</th>
	...
	$html .= '
		<tr>
			...
			<th style="font-weight: 600;">' . AmountValue($VatPerTot) . '</th>
...
if ($LanguageId == 2) {
	...
	$html .= '
	<tr>
		<th style="font-weight: 600; text-align:center;" colspan="6">'.getArabicTitle('Total').'</th>
		<th style="font-weight: 600;">' . AmountValue($QuantityTot) . '</th>
		<th style="font-weight: 600;">' . AmountValue($BonusTot) . '</th>
		<th style="font-weight: 600;">' . AmountValue($PriceTot) . '</th>
		<th style="font-weight: 600;">' . AmountValue($TotalTot) . '</th>
