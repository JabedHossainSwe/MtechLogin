...
///// Main Query/////
echo $mmQ = $mainStoreProcedure . $DataType . $initialLimit;
$result = Run($mmQ);
$print = urlencode($mmQ);
...
<div class="col-md-12 col-sm-12 col-lg-12 mb-4 text-center">
	<div class="d-grid gap-2 col-12 pl-0">
		<button style="width: 130px;" type="button" class="btn btn-w-m btn-outline-primary" id="reportPRint" onclick="PrintPopup('<?= $print ?>', 'Purchase Report General', 'purchaseGeneralDate')"><i class="fa fa-print" aria-hidden="true"></i></button>
	</div>
</div>
<hr>
<!-- Listing -->
<table class="table table-striped table-bordered dt-responsive table-hover ">
	<thead>
		<tr>
			...
			<!-- <th><span class="en">refDate</span><span class="ar"><?= getArabicTitle('refDate') ?></span></th> -->
	...
	if ($pages->items_total > 0) {
		...
		while ($single  =   myfetch($result)) {
			...
			<!-- <td><span class="text-warp"><?php echo $single->refDate; ?> </span></td> -->
