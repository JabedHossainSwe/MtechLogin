...
if ($LanguageId == 1) {
	...
	$html .= '<div id="Sale-Inovice" style="-webkit-print-color-adjust:exact !important;
		...
		<tr>
			<th style="font-weight: 500;">Supplier Name</th>	
	...
	while ($single = myfetch($detailsSp)) {
		...
		$totalVatTot = $totalVatTot + $single->totalVat;
	...
	$html .= '
		<tr>
			...
			<th style="font-weight: 600;">' . AmountValue($totalVatTot) . '</th>
...
if ($LanguageId == 2) {
	...
	<table border="1" style="width: 100%; font-size: 1rem; border-collapse: collapse;">
		<tr>
			<th style="font-weight: 500;">' . getArabicTitle('Supplier Name') . '</th>	
