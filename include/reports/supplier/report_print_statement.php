...
if ($LanguageId == 1) {
	...
	$html .= '<div id="Sale-Inovice" style="-webkit-print-color-adjust:exact !important;
		...
		<tr>
			<th style="font-weight: 500;">TrnsType</th>
			<th style="font-weight: 500;">Billno</th>
			<th style="font-weight: 500;">Billdate</th>
			<th style="font-weight: 500;">RefNo</th>
			<th style="font-weight: 500;">Notes</th>
			<th style="font-weight: 500;">Debit</th>
			<th style="font-weight: 500;">Credit</th>
			<th style="font-weight: 500;">Balance</th>
		</tr>';

	$detailsSp = Run($query);
	while ($single = myfetch($detailsSp)) {
			$DebitTot = $DebitTot + $single->Debit;
			$CreditTot = $CreditTot + $single->Credit;
			$BalanceTot = $BalanceTot + $single->Balance;


		$html .= '
		<tr>
			<th style="font-weight: 300;">' . $single->TrnsType . '</th>
			...
			<th style="font-weight: 300;">' . AmountValue($single->Debit) . '</th>
			<th style="font-weight: 300;">' . AmountValue($single->Credit) . '</th>
	...
	$html .= '
		<tr>
			...
			<th style="font-weight: 600;">' . AmountValue($DebitTot) . '</th>
			<th style="font-weight: 600;">' . AmountValue($CreditTot) . '</th>
...
if ($LanguageId == 2) {
	...
	<table border="1" style="width: 100%; font-size: 1rem; border-collapse: collapse;">
		<tr>
			<th style="font-weight: 500;">' . getArabicTitle('TrnsType') . '</th>
			...
			<th style="font-weight: 500;">' . getArabicTitle('Notes') . '</th>
			<th style="font-weight: 500;">' . getArabicTitle('Debit') . '</th>
			<th style="font-weight: 500;">' . getArabicTitle('Credit') . '</th>
