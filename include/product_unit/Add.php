...
$abc = "Select max(ParaID) as maxBid,max(cast(ParaCode as int)) as maxBd from " . dbObject . "Units";
$myq2 = Run($abc);
  ...
  <form id="save_form">
    <div class="row">
      ...
      <div class="col-12">
        <div class="row">
          <div class="col-md-3">
            <h4><span class="en">Main</span><span class="ar"><?= getArabicTitle('Main') ?></span></h4>
          </div>
          <div class="col-md-9">
            <div class="form-group">
              <select id="MainGid" name="MainGid" class="form-control select2_demo_1 ">
                ...
                <?php
                $Bracnhes = Run("Select * from " . dbObject . "Units  order by ParaName ASC");
                while ($getB = myfetch($Bracnhes)) {
                  ?>
                  <option value="<?= $getB->ParaID ?>"><?= $getB->ParaCode ?>
      ...
      <div class="col-12">
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="form-group">
              <input value="" id="ParaValue" name="ParaValue" type="number" class="grpreq form-control"
                autocomplete="off">
...
<div class="modal-footer">
  <div class="col-md-12 d-flex justify-content-center">
    ...
    <div class="col-md-4">
      ...
      <button type="button" class="btn btn-block btn-outline-primary" id="product_unit_add_btn" onClick="return save()"><span class="en">Save</span><span class="ar"><?= getArabicTitle('Save') ?></span></button>
    </div>
