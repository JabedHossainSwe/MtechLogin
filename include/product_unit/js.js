...
$.post("include/product_unit/loadlisting.php", {}, function (data) {
...
if(lang == 1){
  document.getElementById('modalTitle').innerHTML = "Product Unit";
}
else{
  document.getElementById('modalTitle').innerHTML = "وحدة الصنف";
}
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/product_unit/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/product_unit/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$('#product_unit_add_btn').attr('disabled', true);
$.ajax({
url:"include/product_unit/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$('#product_unit_add_btn').attr('disabled', false);
}
});
...
var myform = document.getElementById("save_form");
var fd = new FormData(myform);
$('#product_unit_update_btn').attr('disabled', true);
$.ajax({
url:"include/product_unit/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
success: function (dataofconfirm) {
$("#save").html(dataofconfirm);
$('#product_unit_update_btn').attr('disabled', false);
}
});
...
$.post("include/product_unit/deleteEntry.php", {id: id}, function (data) {
