...
function saveVoucher() {
  ...
  $.ajax({
    url: "include/branch_receiving/saveVoucher.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
// function validateBranchNo() {
//   var Bid = $("#Bid").val();
//   var salesMan = $("#salesMan").val();

//   if (salesMan == "") {
//     $("#salesMan").css("border", "1px solid red");
//     return false;
//   } else {
//     CheckBranchBill(Bid, purInvNo);
//   }
// }

function CheckBranchBill() {
  var Bid = $("#Bid").val();
  var RefNo1 = $("#RefNo1").val();

  $.post(
    "include/branch_receiving/CheckBranchBill.php",
    {
      Bid: Bid,
      RefNo1: RefNo1,
    },
...
function addRow() {
  ...
  $.post(
    "include/branch_receiving/addRow.php",
    {
      Bid: Bid,
      product: product,
      nrows: nrows,
