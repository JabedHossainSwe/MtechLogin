...
$abc = "Select max(Cid) as maxBid,max(CCode) as maxBd from " . dbObject . "ProductType ";
$myq2 = Run($abc);
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="form-group">
              <input value="" id="Description" name="Description" type="text" class="form-control" autocomplete="off"
                dir="rtl">
