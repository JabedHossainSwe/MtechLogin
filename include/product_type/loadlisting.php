...
$myq2 = Run("Select * from " . dbObject . "ProductType  order by Cid ASC");
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title pb-2">
				<h5><span class="en">Product Type List</span><span class="ar"><?= getArabicTitle('Product Type List') ?></span></h5>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="gradeX">
                                    ...
                                    <td align="center">
										<?php
										$query = Run("Select isnull(count(uid),0) as tlo from product where  producttype = '" . $id . "'");
