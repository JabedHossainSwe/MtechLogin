...
$myq2 = Run("Select count(Cid) as tlo from ".dbObject."ProductType where CName='".$CName."' and Cid !='".$Cid."'");
...
//////////// Insertion/////////////
 $qqq = "Update ".dbObject."ProductType  set CName='".$CName."',Description='".$Description."',dateEdit='".$dateAdd."',empIdEdit='".$empid."' where Cid = '".$Cid."' ";
$insertion = Run($qqq);
?>
