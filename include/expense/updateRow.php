...
<td><input type="hidden" name="isVat<?php echo $row_count ?>" class="" id="isVat<?php echo $row_count ?>" value="<?php echo $isVat ?>">
<input type="hidden" name="vatPer<?php echo $row_count ?>" class="t_vatPer" id="vatPer<?php echo $row_count ?>" value="<?php echo $vatPer ?>">
<?=$isVat?>
</td>
