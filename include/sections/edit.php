...
$abc = "Select * from " . dbObject . "Sections where Cid = '" . $id . "' ";
$myq2 = Run($abc);
...
<div class="modal-footer">
  <div class="col-md-12 d-flex justify-content-center">
    ...
    <div class="col-md-4">
      <button type="button" class="btn btn-block btn-outline-primary" id="sections_update_btn" onClick="return update()"><span class="en">Save</span><span class="ar"><?= getArabicTitle('Save') ?></span></button>
    </div>
  </div>
</div>
</form>
