...
$myq2 = Run("Select * from " . dbObject . "Sections where del=0  order by Cid ASC");
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title pb-3">
                <h5><span class="en">Sections List</span><span class="ar"><?= getArabicTitle('Sections List') ?></span></h5>
