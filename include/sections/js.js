...
$.post("include/sections/loadlisting.php", {}, function (data) {
...
if(lang == 1){
document.getElementById('modalTitle').innerHTML = "Sections";
}
else{
document.getElementById('modalTitle').innerHTML = "اقسام";
}
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/sections/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/sections/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$('#sections_add_btn').attr('disabled', true);
$.ajax({
url:"include/sections/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$('#sections_add_btn').attr('disabled', false);
}
});
...
var myform = document.getElementById("save_form");
var fd = new FormData(myform);
$('#sections_update_btn').attr('disabled', true);

$.ajax({
url:"include/sections/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
success: function (dataofconfirm) {
$("#save").html(dataofconfirm);
$('#sections_update_btn').attr('disabled', false);
}
});
...
$.post("include/sections/deleteEntry.php", {id: id}, function (data) {
