...
$abc = "Select max(Gid) as maxBid,max(Code) as maxBd from " . dbObject . "OfferProductGroup ";
$myq2 = Run($abc);
          ...
          <div class="col-md-9">
            <div class="form-group">
              <select id="MainGid" name="MainGid" class="form-control select2_demo_1 ">
                ...
                <?php
                $Bracnhes = Run("Select * from " . dbObject . "OfferProductGroup where MainGid IS NULL OR MainGid = 0 order by NameEng ASC");
...
<div class="modal-footer">
  <div class="col-md-12 d-flex justify-content-center">
    ...
    <div class="col-md-4">
    <button type="button" class="btn btn-block btn-outline-primary" id="product_offer_group_add_btn" onClick="return save()"><span class="en">Save</span><span class="ar"><?= getArabicTitle('Save') ?></span></button>
    </div>
  </div>
</div>
