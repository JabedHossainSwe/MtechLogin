...
$.post("include/product_offer_group/loadlisting.php", {}, function (data) {
...
if(lang == 1){
  document.getElementById('modalTitle').innerHTML = "Product Offer Group";
}
else{
  document.getElementById('modalTitle').innerHTML = "مجموعة عرف الصنف";
}
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/product_offer_group/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/product_offer_group/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$('#product_offer_group_add_btn').attr('disabled', true);
$.ajax({
url:"include/product_offer_group/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$('#product_offer_group_add_btn').attr('disabled', false);
}
});
...
var myform = document.getElementById("save_form");
var fd = new FormData(myform);
$('#product_offer_group_update_btn').attr('disabled', true);
$.ajax({
url:"include/product_offer_group/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
success: function (dataofconfirm) {
$("#save").html(dataofconfirm);
$('#product_offer_group_update_btn').attr('disabled', false);
}
});
...
$.post("include/product_offer_group/deleteEntry.php", {id: id}, function (data) {
