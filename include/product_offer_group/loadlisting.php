...
$myq2 = Run("Select * from " . dbObject . "OfferProductGroup  order by Gid ASC");
	...
	<div class="col-lg-12">
		<div class="ibox ">
			<div class="ibox-title pb-3">
                <h5><span class="en">Product Offer Group List</span><span class="ar"><?= getArabicTitle('Product Offer Group List') ?></span></h5>
