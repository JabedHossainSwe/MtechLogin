...
$abc = "Select * from " . dbObject . "OfferProductGroup where Gid = '" . $id . "' ";
$myq2 = Run($abc);
			...
			<div class="col-12">
				<div class="row">
					...
					<div class="col-md-9">
						<div class="form-group">
							<?php
							$qp = "Select * from " . dbObject . "OfferProductGroup where  Gid != '" . $id . "' order by NameEng ASC";
							?>
...
<div class="modal-footer">
	<div class="col-md-12 d-flex justify-content-center">
		...
		<div class="col-md-4">
		<button type="button" class="btn btn-block btn-outline-primary" id="product_offer_group_update_btn" onClick="return update()"><span class="en">Save</span><span class="ar"><?= getArabicTitle('Save') ?></span></button>
		</div>
	</div>
</div>
</form>
