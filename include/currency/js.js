...
$.post("include/currency/loadlisting.php", {}, function (data) {
...
if(lang == 1){
  document.getElementById('modalTitle').innerHTML = "Currency";
}
else{
  document.getElementById('modalTitle').innerHTML = "	عملة";
}
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/currency/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/currency/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$('#currency_add_btn').attr('disabled', true);
$.ajax({
url:"include/currency/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$('#currency_add_btn').attr('disabled', false);
}
});
...
var myform = document.getElementById("save_form");
var fd = new FormData(myform);
$('#currency_update_btn').attr('disabled', true);
$.ajax({
url:"include/currency/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
success: function (dataofconfirm) {
$("#save").html(dataofconfirm);
$('#currency_update_btn').attr('disabled', false);
}
});
...
$.post("include/currency/deleteEntry.php", {id: id}, function (data) {
