...
function loadlisting() {
  ...
  $.post("include/customer_area/loadlisting.php", {}, function (data) {
...
function Add() {
  ...
  if(lang == 1){
    document.getElementById('modalTitle').innerHTML = "Customer Area";
  }
  else{
    document.getElementById('modalTitle').innerHTML = "منطقة العميل";
  }
  document.getElementById("helperText").innerHTML = "";
  javascript: $("#myModal2").modal("show", { backdrop: "static" });
  $.post("include/customer_area/Add.php", {}, function (data) {
...
function edit(id) {
  ...
  javascript: $("#myModal2").modal("show", { backdrop: "static" });
  $.post("include/customer_area/edit.php", { id: id }, function (data) {
    $("#modalContent").html(data);
  });
}
...
function save() {
  ...
  $.ajax({
    url: "include/customer_area/save.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function update() {
  ...
  $.ajax({
    url: "include/customer_area/update.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function deleteEntry(id) {
  ...
  if (result) {
    document.getElementById("deleteEntry").innerHTML =
      "<div style='background: #fff;text-align:center'><img width='80px' src='assets/img/loaders/loader.gif'/><div>";
    $.post(
      "include/customer_area/deleteEntry.php",
      { id: id },
      function (data) {
