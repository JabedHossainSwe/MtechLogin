...
Values
(".$BillNO.",'".$BillDate."','".$CustomerID."','".$InvoiceNo."','".$InvoiceDate."','".$NetTotal."','','".$CustomerName."','1','".$Bid."','1' ,'".$_SESSION['id']."','".$SalesmanID."','0' ,'0','','".$sbid."','".$sbBillno."' ,'','')";
$F2 = Run($queryII);
...
<script>
toastr.success('Issue Receipt Saved Successfully.');
location.reload();
