...
$.post("include/bank_deposite/loadlisting.php", {}, function (data) {
...
document.getElementById('modalTitle').innerHTML = "Bank Deposite";
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/bank_deposite/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/bank_deposite/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$.ajax({
url:"include/bank_deposite/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$.ajax({
url:"include/bank_deposite/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$.post("include/bank_deposite/deleteEntry.php", {id: id}, function (data) {
