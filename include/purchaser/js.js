...
$.post("include/purchaser/loadlisting.php", {}, function (data) {
...
if(lang == 1){
  document.getElementById('modalTitle').innerHTML = "Purchaser";
}
else{
  document.getElementById('modalTitle').innerHTML = "المشتري";
}
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/purchaser/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/purchaser/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$.ajax({
url:"include/purchaser/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$.ajax({
url:"include/purchaser/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$.post("include/purchaser/deleteEntry.php", {id: id}, function (data) {
