...
$abc = "Select max(Cid) as maxBid,max(CCode) as maxBd from " . dbObject . "Dept ";
$myq2 = Run($abc);
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <input value="" id="Description" name="Description" type="text" class="grpreq form-control" autocomplete="off" dir="rtl">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="department_add_btn" onClick="return save()"><span class="en">Save</span><span class="ar"><?= getArabicTitle('Save') ?></span></button>
</div>
</form>
<div id="save"></div>
<script>
