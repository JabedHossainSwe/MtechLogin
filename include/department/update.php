...
$myq2 = Run("Select count(Cid) as tlo from ".dbObject."Dept where CName='".$CName."' and Cid !='".$Cid."'");
...
<?php
//////////// Insertion/////////////
 $qqq = "Update ".dbObject."Dept  set CName='".$CName."',Description='".$Description."' where Cid = '".$Cid."' ";
$insertion = Run($qqq);
?>
