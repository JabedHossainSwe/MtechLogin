...
$.post("include/department/loadlisting.php", {}, function (data) {
...
document.getElementById('modalTitle').innerHTML = "Department";
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/department/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/department/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$('#department_add_btn').attr('disabled', true);
$.ajax({
url:"include/department/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$('#department_add_btn').attr('disabled', false);
}
});
...
var myform = document.getElementById("save_form");
var fd = new FormData(myform);
$('#department_update_btn').attr('disabled', true);
$.ajax({
url:"include/department/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
success: function (dataofconfirm) {
$("#save").html(dataofconfirm);
$('#department_update_btn').attr('disabled', false);
}
});
...
$.post("include/department/deleteEntry.php", {id: id}, function (data) {
