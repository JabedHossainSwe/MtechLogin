...
$abc = "Select * from " . dbObject . "Dept where Cid = '" . $id . "' ";
$myq2 = Run($abc);
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <input value="<?= $getData->CName; ?>" id="CName" name="CName" type="text" class="grpreq form-control" autocomplete="off">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <input value="<?= $getData->Description; ?>" id="Description" name="Description" type="text" class="grpreq form-control" autocomplete="off" dir="rtl">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="department_update_btn" onClick="return update()"><span class="en">Save</span><span class="ar"><?= getArabicTitle('Save') ?></span></button>
</div>
</form>
<div id="save"></div>
<script>
