...
$myq2 = Run("Select * from " . dbObject . "Dept  order by Cid ASC");
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title">
                <h5><span class="en">Department List</span><span class="ar"><?= getArabicTitle('Department List') ?></span></h5>

                <div class="ibox-tools" style="top:8px!important;">
                    <div class="col-md-12">
                        <button type="button" onClick="Add()" class="btn btn-block btn-lg btn-success" id="seles_report_search" value="Add"><span class="en">Add <i class="fa fa-plus icon-font"></i></span><span class="ar">اضافة <i class="fa fa-plus icon-font"></i></span>
                        </button>
                    </div>
                </div>
            </div>
