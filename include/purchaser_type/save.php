...
$myq2 = Run("Select count(Cid) as tlo from ".dbObject."Pur_Type where CName='".$CName."'");
...
//////////// Insertion/////////////
$insertion = Run("Insert into ".dbObject."Pur_Type (Cid,CCode,CName,Description,bid,CodeOld,sbid,curMbid,dateAdd,empid) Values ('".$Cid."','".$CCode."','".$CName."','".$Description."','".$bid."','".$CCode."','".$sbid."','".$bid."','".$dateAdd."','".$empid."')");
?>
