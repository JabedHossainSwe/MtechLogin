...
$.post("include/purchaser_type/loadlisting.php", {}, function (data) {
...
if(lang == 1){
  document.getElementById('modalTitle').innerHTML = "Purchase Type";
}
else{
  document.getElementById('modalTitle').innerHTML = "نوع الشراء";
}
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/purchaser_type/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/purchaser_type/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$.ajax({
url:"include/purchaser_type/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$.ajax({
url:"include/purchaser_type/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$.post("include/purchaser_type/deleteEntry.php", {id: id}, function (data) {
