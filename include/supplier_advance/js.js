...
function loadlisting() {
  ...
  $.post("include/supplier_advance/loadlisting.php", {}, function (data) {
...
function Add() {
  ...
  if(lang == 1){
  document.getElementById('modalTitle').innerHTML = "Supplier Advance";
  }
  else{
  document.getElementById('modalTitle').innerHTML = "مقدم المورد";
  }
  document.getElementById("helperText").innerHTML = "";
  javascript: $("#myModal2").modal("show", { backdrop: "static" });
  $.post("include/supplier_advance/Add.php", {}, function (data) {
...
function edit(id) {
  ...
  javascript: $("#myModal2").modal("show", { backdrop: "static" });
  $.post("include/supplier_advance/edit.php", { id: id }, function (data) {
    $("#modalContent").html(data);
  });
}
...
function save() {
  ...
  $.ajax({
    url: "include/supplier_advance/save.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function update() {
  ...
  $.ajax({
    url: "include/supplier_advance/update.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function deleteEntry(billno, bid, sbid) {
  ...
  if (result) {
    document.getElementById("deleteEntry").innerHTML =
      "<div style='background: #fff;text-align:center'><img width='80px' src='assets/img/loaders/loader.gif'/><div>";
    $.post(
      "include/supplier_advance/deleteEntry.php",
      {
        bid: bid,
        sbid: sbid,
        billno: billno,
