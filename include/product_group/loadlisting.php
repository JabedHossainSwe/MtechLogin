...
$myq2 = Run("Select * from " . dbObject . "ProductGroup  order by Gid ASC");
	...
	<div class="col-lg-12">
		<div class="ibox ">
			<div class="ibox-title pb-3">
				<h5><span class="en">Product Group List</span><span class="ar"><?= getArabicTitle('Product Group List') ?></span></h5>
				...
				<div class="ibox-tools" style="top:8px!important;">
					<div class="col-md-12">
						<button type="button" onClick="Add()" class="btn btn-block btn-lg btn-outline-primary"
							id="seles_report_search" value="Add"><span class="en">Add <i class="fa fa-plus icon-font"></i></span><span
								class="ar">اضافة <i class="fa fa-plus icon-font"></i></span>
						</button>
					</div>
				</div>
			</div>
						...
						<tbody>
							...
							while ($load = myfetch($myq2)) {
								...
								if (empty($load->MainGid)) {
									...
									$qp = Run("Select * from " . dbObject . "ProductGroup where Gid = '" . $load->MainGid . "'");
								...
								<tr class="gradeX">
									...
									<td align="center">
										...
										&nbsp;
										<?php
										$query = Run("Select isnull(count(uid),0) as tlo from product where  pgid = '" . $id . "'");
