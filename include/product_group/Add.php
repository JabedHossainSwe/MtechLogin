...
$abc = "Select max(Gid) as maxBid,max(cast(Code as int)) as maxBd from " . dbObject . "ProductGroup ";
$myq2 = Run($abc);
          ...
          <div class="col-md-9">
            <div class="form-group">
              <select id="MainGid" name="MainGid" class="form-control select2_demo_1 ">
                ...
                <?php
                $Bracnhes = Run("Select * from " . dbObject . "ProductGroup where MainGid IS NULL order by NameEng ASC");
...
<div class="modal-footer">
  <div class="col-md-12 d-flex justify-content-center">
    ...
    <div class="col-md-4">
      <button type="button" class="btn btn-block btn-outline-primary" id="add_product_group_btn" onClick="return save()"><span class="en">Save</span><span class="ar"><?= getArabicTitle('Save') ?></span></button>
    </div>
