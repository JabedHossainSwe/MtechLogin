...
$.post("include/product_group/loadlisting.php", {}, function (data) {
...
if(lang == 1){
  document.getElementById('modalTitle').innerHTML = "Product Group";
}
else{
  document.getElementById('modalTitle').innerHTML = "مجموعة الأصناف";
}
document.getElementById('helperText').innerHTML = "";
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/product_group/Add.php", {}, function (data) {
...
javascript:$('#myModal2').modal('show', {backdrop: 'static'});
$.post("include/product_group/edit.php", {id: id}, function (data) {
$("#modalContent").html(data);
});
}
...
$('#add_product_group_btn').attr('disabled', true);
$.ajax({
url:"include/product_group/save.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$('#add_product_group_btn').attr('disabled', false);
}
});
...
$.ajax({
url:"include/product_group/update.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
$.post("include/product_group/deleteEntry.php", {id: id}, function (data) {
