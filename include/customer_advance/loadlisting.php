...
$mainQuery = "Select Customeradvance.*,CustFile.CName from " . dbObject . "Customeradvance Inner Join " . dbObject . "CustFile on CustFile.Cid=Customeradvance.SuppID where Customeradvance.IsDeleted=0  order by Customeradvance.Billno DESC";
$myq2 = Run($mainQuery);
