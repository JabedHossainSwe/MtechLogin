	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Purchase Report (Group)</span><span class="ar"><?= getArabicTitle('Purchase Report (Group)') ?></span></h2>
				</div>
				<div class="col-lg-2">
...
//////////////// Branches Filter//////////////
										...
										include("include/reports/purchase/purchase_group/index.php");
