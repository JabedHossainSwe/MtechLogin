...
<body class="pace-done mini-navbar">
	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			$queryForMax = Run("Select max(BillNo) as bno from " . dbObject . "Payables");
						...
						<div class="col-lg-12">
							<div class="ibox">
								<div class="ibox-title">
									<div class="row">
										<div class="col-md-12">
											<h5 class="mr-4 float-left en">Issue Payment Report</h5>
											<h5 class="mr-4 float-right ar"><?= getArabicTitle('Issue Payment Report') ?></h5>
										</div>
									</div>
								</div>
...
<script src="include/payment/js.js"></script>
<script>
