	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Sales Return Report (Detail)</span><span class="ar"><?= getArabicTitle('Sales Return Report (Detail)') ?></span></h2>
				</div>
				<div class="col-lg-2">
							...
							<form action="" id="sales_report_form" method="get" class="ibox-content filter_container">
								...
								<div class="row">
									...
									<div class="col-6">
										<div class="row">
											...
											<div class="col-md-2 col-4">
												<div class="form-group"><input id="customer_id" name="customer_id" type="text"
									...
									<div class="col-4">
										<div class="row">
											<div class="col-md-4">
												<h4><span class="en">From Product</span><span class="ar"><?= getArabicTitle('From Product') ?></span></h4>
											</div>
											<div class="col-md-2 col-4">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-md-4">
												<h4><span class="en">To Product</span><span class="ar"><?= getArabicTitle('To Product') ?></span>
												</h4>
											</div>
											<div class="col-md-2 col-4">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-md-4">
												<h4><span class="en">Product Group</span><span class="ar"><?= getArabicTitle('Product Group') ?></span></h4>
											</div>
											<div class="col-md-2 col-4">
													...
													<div class="col-md-6 col-6">
														<div class="i-checks"><label class="">
																<div class="iradio_square-green ">
																	...
																	<ins class="iCheck-helper"></ins>
																</div> <i></i> <span class="en">Group by Product </span><span class="ar"><?= getArabicTitle('Group by Product') ?></span>
															</label>
														</div>
													</div>
									...
									<div class="col-12 row justify-content-center mt-5">
										<div class="col-md-2"><button type="button" class="btn btn-block btn-lg btn-outline-danger"><span
										...
										<div class="col-md-2">
											<button type="submit" class="btn btn-block btn-lg btn-outline-success"
												id="seles_report_search"><span class="en">Search</span><span class="ar"><?= getArabicTitle('Search') ?></span>
											</button>
										</div>
									</div>
								</div>
...
//////////////// Branches Filter//////////////
										...
										if ($_GET['GroupByType'] == '') {
											include("include/reports/sales/sales_return_detail/groupbynone.php");
										}

										if ($_GET['GroupByType'] != '') {
											$GroupByType = "1";
											$OrderBy = '';
											include("include/reports/sales/sales_return_detail/groupbyproduct.php");
										}
