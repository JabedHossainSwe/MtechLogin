...
while ($counter <= $row_count) {
  ...
  if ($PCode != '0' && $PCode != '') {
    ...
    //"@PurDetail= CSID(Supplier Id),bid,Pid,Uid,Qty,dbo.GetQtyInLow(unitvalue,qtyValue),Price,Total,,Discount,NetTotal,altCode,EmpID,ResEmpID,vatPer,vatAmt,vatTotal,vatPTotal,Autono"
...
$PurDetail =  ltrim($PurDetail, $delimeter);
 ...
 $purchaseOrderSP = "EXECUTE ".dbObject."[InsertDataInOrder]
  @BillDate='".$billDate."'
  ,@Bid=$Bid
  ,@CSID=$CSID
  ,@Total=$f_total_int
