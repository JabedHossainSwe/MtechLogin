...
$ff = "Exec " . dbObject . "SPInventolrySelectWeb @SrchBy=1,@Billno=$Billno,@Bid=$Bid,@sBid=$sbid,@LanguageId=$LanguageId,@FRecNo=0,@ToRecNo=1";
...
if ($Billno == '') {
  ...
  $sale_invoice = getInventoryDataTemplate($GotBill, $Bid, $LanguageId);
  ...
  // $mpdf->Output();
  $mpdf->Output('Inventory Data Invoice-' . $language . '-' . $Billno . '.pdf', 'D');
