...
$total = addslashes($_POST['netTotal']);
...
$netTotalotalWithTax = $total_with_tax;
...
?>
    ...
    <td><input type="hidden" name="moreTotal<?php echo $row_count ?>" id="moreTotal<?php echo $row_count ?>" value="<?php echo $moreTotal;?>" class="tot_Sprice" ><?php echo $moreTotal;?></td>
    <td><input type="hidden" name="lessTotal<?php echo $row_count ?>" id="lessTotal<?php echo $row_count ?>" value="<?php echo $lessTotal;?>" class="tot_Sprice" ><?php echo $lessTotal;?></td>
