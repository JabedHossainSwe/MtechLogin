...
function updateRow(idx) {
  ...
  $.post(
    "vouchers/stockOut/updateRow.php",
    {
      Pcode: code,
      product: product_name,
      unit_id: unit,
...
function getProductUnit(code) {
  ...
  $.post(
    "vouchers/stockOut/getProductUnit.php",
    {
      code: code,
    },
    function (data) {
...
function SaveSalesVoucher() {
  ...
  document.getElementById("SalesVoucherDiv").innerHTML =
    "<div style='background: #fff;text-align:center'><img width='80px' src='assets/img/loaders/loader.gif'/><div>";
  $.ajax({
    url: "vouchers/stockOut/SaveSalesVoucher.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function UpdateSalesVoucher() {
  ...
  document.getElementById("SalesVoucherDiv").innerHTML =
    "<div style='background: #fff;text-align:center'><img width='80px' src='assets/img/loaders/loader.gif'/><div>";
  $.ajax({
    url: "vouchers/stockOut/UpdateSalesVoucher.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function fetchProductDetailsFromCode(vvl, Uid) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/stockOut/fetchProductDetailsFromCode.php",
      {
        code: vvl,
        Bid: Bid,
        Uid: Uid,
...
function fetchProductUnits(vvl) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/stockOut/fetchProductUnits.php",
      {
        code: vvl,
        Bid: Bid,
      },
...
function setProductUnits(vvl,uid) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/stockOut/setProductUnits.php",
      {
        code: vvl,
        Bid: Bid,
        uid: uid,
...
function fetchProductDetails(vvl, Uid) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/stockOut/fetchProductDetails.php",
      {
        code: vvl,
        Bid: Bid,
        Uid: Uid,
...
function Pricecalculations(vvl, tp) {
  ...
  if (vatPer != "0") {
    $.post(
      "vouchers/stockOut/Pricecalculations.php",
      {
        vvl: vvl,
        tp: tp,
        vatPer: vatPer,
...
function LoadUnitPrice(Uid, vvl) {
  if (vvl != "" && Uid != "") {
    ...
    document.getElementById("fetchProductDetails").innerHTML =
      "<img width='80px' src='loader/wheel.gif'/>";
    $.post(
      "vouchers/stockOut/LoadUnitPrice.php",
      {
        code: vvl,
        Bid: Bid,
        Uid: Uid,
...
function getProductList(vvl) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/stockOut/getProductList.php",
      {
        code: vvl,
      },
      function (data) {
...
function CheckSaleBill(sale_bill_no) {
  ...
  document.getElementById("fetchProductDetails").innerHTML="<img width='80px' src='loader/wheel.gif'/>";
  $.post(
    "vouchers/stockOut/CheckSaleBill.php",
    {
      Bid: Bid,
      Billno: sale_bill_no,
    },
...
function CheckDeliveryBill() {
  ...
  document.getElementById("fetchProductDetails").innerHTML="<img width='80px' src='loader/wheel.gif'/>";
  $.post(
    "vouchers/stockOut/CheckDeliveryBill.php",
    {
      Bid: Bid,
      Billno: deliveryNo,
    },
...
function product_add_addRow(Bid, Billno, sBid, LanguageId) {
  var in_html = $("#row_append").html();
  $.post(
    "vouchers/stockOut/sections/product_add_addRow.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function product_add_addRow_Delivery(Bid, Billno, sBid, LanguageId) {
  var in_html = $("#row_append").html();
  $.post(
    "vouchers/stockOut/sections/product_add_addRow_Delivery.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function bank_section(Bid, Billno, sBid, LanguageId) {
  ...
  $.post(
    "vouchers/stockOut/sections/bank_section.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function loadBanks(vvl) {
  if (vvl != "") {
    document.getElementById("cashCreditOption").innerHTML =
      "<img width='80px' src='loader/wheel.gif'/>";
    $.post(
      "vouchers/stockOut/loadBanks.php",
      {
        code: vvl,
      },
      function (data) {
...
function sale_bill_no_area(Bid, Billno, sBid, LanguageId) {
  document.getElementById("sale_bill_no_area").innerHTML =
    "<img width='80px' src='loader/wheel.gif'/>";
  $.post(
    "vouchers/stockOut/sections/sale_bill_no_area.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function saveFinalStep(SBBillno, Bid) {
  $.post(
    "vouchers/stockOut/saveFinalStep.php",
    {
      SBBillno: SBBillno,
      Bid: Bid,
    },
...
function customerValidation(e) {
  ...
  if (anyaction) {
    ...
    //   "<img width='80px' src='loader/wheel.gif'/>";
    $.ajax({
      url: "vouchers/stockOut/updateSalesForm.php",
      data: fd,
      cache: false,
      processData: false,
      contentType: false,
...
function reloadVoucher() {
  ...
  if (anyaction) {
    ...
    $.post(
      "vouchers/stockOut/reloadVoucher.php",
      {
        Bid: Bid,
        Billno: Billno,
      },
...
function CheckQuotationBill() {
  ...
  if (anyaction) {
    ...
    $.post(
      "vouchers/stockOut/CheckQuotationBill.php",
      {
        Bid: Bid,
        Billno: Billno,
      },
...
function editVoucher(Bid, Billno) {
  ...
  $.post(
    "vouchers/stockOut/editVoucher.php",
    {
      Bid: Bid,
      Billno: Billno,
    },
...
function editVoucherDelivery(Bid, Billno) {
  ...
  $.post(
    "vouchers/stockOut/editVoucherDelivery.php",
    {
      Bid: Bid,
      Billno: Billno,
    },
...
function quotation_bill_no_area(Bid, Billno, sBid, LanguageId) {
  ...
  $.post(
    "vouchers/stockOut/sections/quotation_bill_no_area.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function Quotation_product_add_addRow(Bid, Billno, sBid, LanguageId) {
  var in_html = $("#row_append").html();
  $.post(
    "vouchers/stockOut/sections/Quotation_product_add_addRow.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function product_add_addRow(Bid, Billno, sBid, LanguageId) {
  var in_html = $("#row_append").html();
  $.post(
    "vouchers/stockOut/product_add_addRow.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function deleteSale(Billno, Bid, sBid) {
  ...
  $.post(
    "vouchers/stockOut/deleteSale.php",
    {
      Billno: Billno,
      Bid: Bid,
      sBid: sBid,
...
function Print_report_details()
{
  ...
  window.open(
    'vouchers/stockOut/print.php?Billno='+bill_no+'&Bid='+Bid+'&LanguageId='+print_language+'',
    '_blank' // <- This is what makes it open in a new window.
    );
}
...
$.post("vouchers/stockOut/send_email.php",{
b_id:b_id,
bill_id:bill_id,
LanguageId:LanguageId,
email:email,
...
document.getElementById("loadBanksagainstBrank").innerHTML ="<img width='80px' src='loader/wheel.gif'/>";
	$.post(
    "vouchers/stockOut/loadBanksagainstBrank.php",
    {
      code: bnkVal,
    },
    function (data) {
...
document.getElementById("loadBanksagainstBrank").innerHTML ="<img width='80px' src='loader/wheel.gif'/>";
	$.post(
    "vouchers/stockOut/sections/loadBanksagainstBranchWithBill.php",
    {
      Bid: Bid,
      BillNo: BillNo,
    },
...
function getCustVatNo(){
  ...
  $.post(
    "vouchers/stockOut/getCustVatNo.php",
    {
