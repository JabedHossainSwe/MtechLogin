<?php
$qqst = "SELECT  count(sdet.BillNo) as tol FROM (Product INNER JOIN (Emp INNER JOIN (DataOutReturnDetail sdet  LEFT JOIN CustFile ON sdet.CSID = CustFile.Cid) ON Emp.Cid = sdet.EmpID)
...
$pages->paginate();	
  ...
  $qq = "
Select Branch.BName BranchName,sdet.BillNo, 
sdet.SPType, CAST(CONVERT(VARCHAR(10),sdet.billdate,121) AS DATETIME) + space(1) + sdet.CompTime as BillDate, 
...
Product.PCode ProductCode, Product.PName ProductName,Product.PGID, ProductGroup.NameArb as ProductGroup ,
sdet.Qty Quantity, sdet.Price Price, sdet.NetTotal NetTotal, CustFile.CName as Customer, 
Units.ParaName UnitName, sdet.CSID,
sdet.bid 

 FROM (Product INNER JOIN (Emp INNER JOIN (DataOutReturnDetail sdet  LEFT JOIN CustFile ON sdet.CSID = CustFile.Cid) ON Emp.Cid = sdet.EmpID)
...
////// $querySUm///////////
 ...
 SUM(sdet.Bonus) as ToBonus,SUM(sdet.Price) as ToPrice,SUM(sdet.Discount) as ToDiscount,SUM(sdet.vatPer) as TovatPer,SUM(sdet.vatAmt) as TovatAmt,SUM(sdet.vatTotal) as TovatTotal,SUM(sdet.vatPTotal) as TovatPTotal
...
<th><span class="en">Bonus</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Unit Name</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Price</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Discount</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Total</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Vat%</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Vat Amount</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Vat Total</span><span class="ar">نوع الفاتورة</span></th>
<th><span class="en">Grand Total </span><span class="ar">نوع الفاتورة</span></th>
...
?>
<tr>
<td colspan="23" class="text-center"><h2><strong><span class="en">No Record(s) Found..</span><span class="ar"><?= getArabicTitle('No Record(s) Found..') ?></span></strong></h2></td>
</tr>
<?php
