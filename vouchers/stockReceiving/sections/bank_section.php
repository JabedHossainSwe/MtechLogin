...
<input class="form-check-input SPType" onClick="checkBankValue()" <?php if($SPType=='1'){ echo "Checked"; } ?> type="radio" name="SPType" id="cash"
value="1">
...
<div class="mb-3 col-6">
<div class="form-check">
<input class="form-check-input SPType" type="radio" name="SPType" id="credit" <?php if($SPType=='2'){ echo "Checked"; } ?> onClick="checkBankValue()"
value="2">
...
<div id="cashCreditOption" <?php if($SPType !='1'){ echo 'style="display:none"'; } ?>>
...
<td>
<input type="text" id="sal_amount<?=$nrow?>" name="sal_amount<?=$nrow?>" class="form-control <?php if($nrow!=1){echo 'salAmnt';}?>  " value="<?=$getD->amount?>" onKeyUp="CalculateRemainings()"  <?php if($nrow==1){echo 'readonly';}?>  >
</td>
</tr>
