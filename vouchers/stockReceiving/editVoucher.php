...
$QueryGet = Run("Select *,[Discount%] as disper from " . dbObject . "DataOut where Billno = $Billno and Bid = $Bid");
            ...
            <div class="col-6">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <?php
                  $qt = "select BillNo from dataout where BillNo = (select max(BillNo) from 
dataout where BillNo < '" . $Billno . "' and Bid='" . $Bid . "' and isDeleted = 0) 
          ...
          <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-total_int">
                    <input id="f_total" name="f_total" type="text" readonly value="<?= $billData->Total ?>" class="form-control">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-2">
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    <input id="totVat" name="totVat" readonly type="text" value="<?= $billData->totalVat ?>" class="form-control">
                  </div>
                </div>
              </div>
            </div>
