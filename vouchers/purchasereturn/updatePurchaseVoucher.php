...
while ($counter <= $row_count) {
  ...
  if ($PCode != '0' && $PCode != '') {
    ...
    $delimeter = 'µ';
    $GetQtyInLow = "dbo.GetQtyInLow(" . $Uid . "," . $bonusQTyValue1 . ")";
    ...
    $currentRow = $CSID . "," . $Bid . "," . $Pid . "," . $Uid . "," . $Qty . "," . $GetQtyInLow. "," . $bonus . "," . $QtyInLowQtyBOnus  . "," . $price . "," . $total . "," . $disPer . "," . $disAmt . "," . $net_total . "," . $vatPer . "," . $vatAmt . "," . $vattotal . "," . $vatPTotal . "," . $cpp . "," . $level3 . "," . $SPrice . "," . $LSPrice  . "," . $altCode . "," . $EmpID . "," . $ResEmpID . "," . $counter;
    // die();
...
if ($SPType == '1') {
  ...
  $qry = "EXECUTE[dbo].[UpdateDataInReturnWeb]	
  @Billno=$Billno
  ,@BillDate='$billDate'	
	,@Bid=$Bid
	,@CSID=$CSID	
