...
$ff = "Select *,[Discount%] as disper from " . dbObject . "DataInReturn where Billno = $Billno and Bid = $Bid";
...
if ($Billno == '') {
  ...
  $sale_invoice = getPurchaseReturnPrintTemplateNew($GotBill, $Bid, $LanguageId);
  ...
  //$mpdf->Output();
  $mpdf->Output('Purchase Return Invoice-' . $language . '-' . $Billno . '.pdf', 'D');
