...
function fetchSupplierDetails(vvl) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/purchasereturn/fetchSupplierDetails.php",
      {
        Cid: vvl,
      },
      function (data) {
...
function addRow() {
  ...
  $.post(
    "vouchers/purchasereturn/addRow.php",
    {
      code: code,
      product: product,
...
function edit_row(idx) {
  ...
  // $.post("vouchers/purchasereturn/AddPurchase.php", {}, function (data) {
  ...
  $(document).ready(function () {
    ...
    var newOption = new Option(product_name, code, true, true);
    // Append it to the select
...
function updateRow(idx) {
  ...
  $.post(
    "vouchers/purchasereturn/updateRow.php",
    {
      code: code,
      product: product,
      product_name: product_name,
...
function getProductUnit(code) {
  ...
  $.post(
    "vouchers/purchasereturn/fetchProductUnits.php",
    {
      code: code,
      Bid: Bid,
    },
...
function salesAddRowCalculations() {
  ...
  var vatTotal = parseFloat(qty) * parseFloat(vatAmt);
...
function SaveSalesVoucher() {
  ...
  $.ajax({
    url: "vouchers/purchasereturn/SaveSalesVoucher.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function fetchProductDetailsFromCode(vvl, Uid) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/purchasereturn/fetchProductDetailsFromCode.php",
      {
        code: vvl,
        Bid: Bid,
        Uid: Uid,
...
function getProductList(vvl) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/purchasereturn/getProductList.php",
      {
        code: vvl,
      },
      function (data) {
...
function fetchProductDetails(vvl, Uid) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/purchasereturn/fetchProductDetails.php",
      {
        code: vvl,
        Bid: Bid,
        Uid: Uid,
...
function LoadUnitPrice(Uid, vvl) {
  if (vvl != "" && Uid != "") {
    ...
    // document.getElementById('fetchProductDetails').innerHTML ="<img width='80px' src='loader/wheel.gif'/>";
    $.post(
      "vouchers/purchasereturn/LoadUnitPrice.php",
      {
        code: vvl,
        Bid: Bid,
        Uid: Uid,
...
function Pricecalculations(vvl, tp) {
  ...
  if (vatPer != "0") {
    $.post(
      "vouchers/purchasereturn/Pricecalculations.php",
      {
        vvl: vvl,
        tp: tp,
        vatPer: vatPer,
...
function PricecalculationsRow(vvl, tp, row_count) {
  ...
  if (vatPer != "0") {
    $.post(
      "vouchers/purchasereturn/PricecalculationsRow.php",
      {
        vvl: vvl,
        tp: tp,
        vatPer: vatPer,
...
function validateSaleNo() {
  var purchase_bill = $(".purchase_bill:checked").val();
  var Bid = $("#Bid").val();

  if (purchase_bill == "No") {
    $.post(
      "vouchers/purchasereturn/addReturn.php",
      {
        Bid: Bid,
      },
      function (data) {
        //   $("#CheckPurchaseBill").html(data);
        $("#addRow").css("display", "block");
        $("#screen_sec").html(data);
      }
    );

    // $("#purchase_bill_no").val("");
  }
  if (purchase_bill == "Yes") {
    ...
    CheckPurchaseBill(purchase_bill_no);

    $.post(
      "vouchers/purchasereturn/addOld.php",
      {
...
function CheckPurchaseBill(purchase_bill_no) {
  var Bid = $("#Bid").val();
  // document.getElementById("CheckPurchaseBill").innerHTML = "<img width='80px' src='loader/wheel.gif'/>";
  $.post(
    "vouchers/purchasereturn/CheckPurchaseBill.php",
    {
      Bid: Bid,
      Billno: purchase_bill_no,
    },
...
function reloadVoucher() {
  ...
  if (anyaction) {
    ...
    $.post(
      "vouchers/purchasereturn/reloadVoucher.php",
      {
        Bid: Bid,
        Billno: Billno,
      },
...
function editVoucher(Bid, Billno) {
  ...
  $.post(
    "vouchers/purchasereturn/editVoucher.php",
    {
      Bid: Bid,
      Billno: Billno,
    },
...
function deletePurchase(Billno, Bid, sBid) {
  ...
  $.post(
    "vouchers/purchasereturn/deletePurchase.php",
    {
      Billno: Billno,
      Bid: Bid,
      sBid: sBid,
...
function Print_voucher_details() {
  ...
  window.open(
    "include/reports/purchasereturn/general_print.php?query=" +
      bill_query +
      "&LanguageId=" +
      print_language +
      "&type=" +
...
function Print_report_details() {
  ...
  window.open(
    "vouchers/purchasereturn/print.php?Billno=" +
      bill_no +
      "&Bid=" +
      Bid +
      "&LanguageId=" +
...
function sendemailVoucher() {
  ...
  $.post(
    "vouchers/purchasereturn/send_email.php",
    {
      b_id: b_id,
      bill_id: bill_id,
...
function purchase_return_addRow(Bid, Billno, sBid, LanguageId) {
  $.post(
    "vouchers/purchasereturn/purchase_return_addRow.php",
    {
      Bid: Bid,
      Billno: Billno,
      sBid: sBid,
...
function UpdatePurchaseReturn() {
  ...
  document.getElementById("SalesVoucherDiv").innerHTML =
    "<div style='background: #fff;text-align:center'><img width='80px' src='assets/img/loaders/loader.gif'/><div>";
  $.ajax({
    url: "vouchers/purchasereturn/updatePurchaseVoucher.php",
    data: fd,
    cache: false,
    processData: false,
    contentType: false,
...
function setProductUnits(vvl, uid) {
  if (vvl != "") {
    ...
    $.post(
      "vouchers/purchasereturn/setProductUnits.php",
      {
        code: vvl,
        Bid: Bid,
        uid: uid,
...
function loadBanksagainstBrank(bnkVal) {
  if (bnkVal != "") {
    document.getElementById("loadBanksagainstBrank").innerHTML =
      "<img width='80px' src='loader/wheel.gif'/>";
    $.post(
      "vouchers/purchasereturn/loadBanksagainstBrank.php",
      {
        code: bnkVal,
      },
      function (data) {
...
function loadBanksagainstBranchWithBill(Bid, BillNo, sBid) {
  $.post(
    "vouchers/purchasereturn/loadBanksagainstBranchWithBill.php",
    {
      Bid: Bid,
      BillNo: BillNo,
      sBid: sBid,
