...
?>
    ...
    <td>
        <input type="hidden" name="Sprice<?php echo $row_count ?>" class="" id="Sprice<?php echo $row_count ?>" value="<?php echo $Sprice ?>"><?php echo $Sprice ?>
    </td>
 <td><input type="hidden" name="vatPer<?php echo $row_count ?>" class="t_vat_per" id="vatPer<?php echo $row_count ?>" value="<?php echo $vatPer ?>"><?php echo $vatPer ?></td>
    ...
    <td>
        <input type="hidden" name="vatSprice<?php echo $row_count ?>" class="t_Sprice" id="vatSprice<?php echo $row_count ?>" value="<?php echo $vatSprice ?>"><?php echo $vatSprice ?>
