...
?>
    ...
    <td>
        ...
        <input type="hidden" name="Sprice<?php echo $row_count ?>" id="Sprice<?php echo $row_count ?>" value="<?php echo $Sprice ?>" class="t_s_price">
    </td>
    <td>
        ...
        <input type="hidden" name="netTotal<?php echo $row_count ?>" id="netTotal<?php echo $row_count ?>" value="<?php echo $total;?>" class="tot_Sprice"><?php echo $total;?>
