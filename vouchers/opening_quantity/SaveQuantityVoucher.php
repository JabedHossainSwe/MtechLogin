...
$SalDetail =  ltrim($SalDetail, $delimeter);
 ...
 $openingSp = "EXECUTE  " . dbObject . "[InsertOpenQuantityWeb]
@BillDate='$BillDate'
,@Bid=$Bid
,@NetTotal=$NetTotal
,@EmpID=$EmpID
...
$postSp = "Exec " . dbObject . "IsPostedOpenQuantityWeb @BillNo=$SBBillno,@Bid =$Bid,@sbid=$sbid,@ResEmpID=$ResEmpID,@IsExpImp= 0";
$execute = Run($postSp);
