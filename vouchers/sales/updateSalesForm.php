...
// Delete Old Data
// $del = "delete from SPSalesSelectWeb where SrchBy=1 and Billno='".$Billno."' and Bid='".$Bid."' and sBid=1 and LanguageId='".$LanguageId."' and FRecNo=0 and ToRecNo=1";

// $del = "Exec ".dbObject."SPSalesSelectWeb @SrchBy=1,@Billno=$Billno,@Bid=$Bid,@sBid=1,@LanguageId=$LanguageId,@FRecNo=0,@ToRecNo=1";
Run($del);
