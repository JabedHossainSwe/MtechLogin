...
$row_count = 1;
echo $tt = "EXECUTE " . dbObject . "SPSalDetSelectWeb @Billno=$Billno,@Bid=$Bid,@sBid=$sBid";
$detailsSp = Run($tt);
while ($getDetails = myfetch($detailsSp)) {
    ...
    $vatTotal = round($getDetails->vatTotal, 2);
    $description = $getDetails->ProdDesc;
    echo $CostPrice = $getDetails->cpp;
    echo $costTotal = $getDetails->cst;
...
?>
    ...
    <tr id="row_<?php echo $row_count ?>">
        ...
        <td>
            <input type="hidden" name="product_name<?php echo $row_count ?>" id="product_name<?php echo $row_count ?>" value="<?php echo $product_name ?>">
            <input type="hidden" name="description<?php echo $row_count ?>" id="description<?php echo $row_count ?>" value="<?php echo $description ?>">
