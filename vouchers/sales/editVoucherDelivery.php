          ...
          <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-total_int">
                    <input id="total" name="total" type="text" readonly value="<?= round($billData->Total, 2) ?>" class="form-control">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-2">
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    <input id="disPer" name="disPer" type="text" class="form-control" value="<?= round($billData->DisPer, 2) ?>" onkeyup="calculateWholeDiscountAmount(this.value)">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-2">
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    <input id="netTotal" name="netTotal" readonly type="text" value="<?= round($billData->Nettotal, 2) ?>" class="form-control tot_Sprice">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-2">
              <div class="row">
                ...
                <div class="col-md-7">
                  <div class="form-group">
                    <input value="<?= round($billData->Nettotal, 2) ?>" id="grandTotal" name="grandTotal" readonly type="text" class="form-control">
                  </div>
                </div>
              </div>
            </div>
