...
$.ajax({
url:"vouchers/sales/saveSalesForm.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
if (Pcode != '') {
$.post("vouchers/sales/addRow.php", {
Pcode: Pcode,
product: product,
unit_id: unit_id,
unit: unit,
...
$.post("vouchers/sales/fetchProductDetails.php",{
code:vvl,
Bid:Bid
},function(data){
...
$.post("vouchers/sales/fetchProductDetailsFromCode.php",{
code:vvl,
Bid:Bid
},function(data){
$("#fetchProductDetails").html(data);});
...
$.post("vouchers/sales/getProductList.php",{
code:vvl,
},function(data){
...
$.post("vouchers/sales/loadBanks.php",{
code:vvl,
},function(data){
...
if(vatPer!='0')
{
$.post("vouchers/sales/Pricecalculations.php",{
vvl:vvl,
tp:tp,
vatPer:vatPer,
vatAmt:vatAmt,
...
if(vatPer!='0')
{
$.post("vouchers/sales/PricecalculationsRow.php",{
vvl:vvl,
tp:tp,
vatPer:vatPer,
vatAmt:vatAmt,
...
$.post("vouchers/sales/saveFinalStep.php",{
SBBillno:SBBillno,
Bid:Bid,
},function(data){
...
$.post("vouchers/sales/printInvoice.php",{
Bid:Bid,
Billno:Billno,
...
window.open(
'vouchers/sales/print.php?Billno='+bill_id+'&Bid='+b_id+'&LanguageId='+print_language+'',
