...
<div class="content_form">
	<div class="form_list">
		<div class="mb-3">
			<span class="en">Grand Total :</span><span id="payment_screen_total"><span class="ar">: <?= getArabicTitle('Grand Total') ?>

		</div>
		<div class="mb-3" style="display: none;">
			<span class="en">Remaining :</span><span id="payment_screen_remaining"><span class="ar">: <?= getArabicTitle('Remaining') ?>
...
<input type="button" onClick="bank_section('<?=$Bid?>','<?=$Billno?>','<?=$sBid?>',<?=$LanguageId?>);	" value="reload"><?php */ ?>
			...
			<div class="mb-3">
				<label for="" class="form-label add_icon"><span class="en">Shop Name</span><span class="ar"><?= getArabicTitle('Shop Name') ?></span></label>
	...
	Where b.id=d.paytype  and billno='" . $Billno . "' and d.bid='" . $Bid . "' and d.sbid='" . $sBid . "' and b.mbid='" . $Bid . "' and b.id='" . $getBranches->id . "'   order by d.id");
		...
		<div class="mb-3 overflow-hidden">
			<button type="button" class="btn btn-info btn-actions float-start back text-white" onclick="prev(this);"><span class="en"><i class="fa fa-arrow-left icon-font"></i>&nbsp;Back</span><span class="ar"><?= getArabicTitle('Back') ?>&nbsp;<i class="fa fa-arrow-right icon-font"></i></span></button>
