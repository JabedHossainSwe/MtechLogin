...
<div class="modal-body direction" id="modalBody">
    <div class="form-body p-0 m-0">
        ...
        <div class="row d-flex justify-content-between mb-2">
            ...
            <div class="col-md-4 row">
                <div class="col-md-4 p-0 m-0">
                    <h4><span class="en">CPP</span><span class="ar"><?= getArabicTitle('CPP') ?></span></h4>
                </div>
                <div class="form-group col-md-8 p-0 m-0">
            ...
            <div class="col-md-4 row">
                <div class="col-md-4 p-0 m-0">
                    <h4><span class="en">ACP</span><span class="ar"><?= getArabicTitle('ACP') ?></span></h4>
                </div>
                <div class="form-group col-md-8 p-0 m-0">
