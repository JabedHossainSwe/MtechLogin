...
<body class="pace-done mini-navbar">
	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			?>
			<div class="row wrapper border-bottom white-bg page-heading pb-2 direction">
				<div class="col-lg-4">
					<h2 class="font-weight-bold en float-left">Sales Report (Group) </h2>
					<h2 class="font-weight-bold ar float-right"><?= getArabicTitle('Sales Report (Group)') ?></h2>
				</div>
				<div class="col-lg-2">
								...
								<div class="row">
										...
										<div class="row">
											...
											<div class="col-md-2 col-4">
												<div class="form-group"><input id="from_product_id" name="from_product_id" type="text"
														class="form-control" value="<?php echo $_GET['from_product_id'] ?>"></div>
											</div>
											<div class="col-md-6 col-8">
												<div class="form-group">
													<div>
										...
										<div class="row">
											...
											<div class="col-md-2 col-4">
												<div class="form-group"><input id="to_product_id" name="to_product_id" type="text"
														class="form-control" value="<?php echo $_GET['to_product_id'] ?>"></div>
											</div>
											<div class="col-md-6 col-8">
												<div class="form-group">
													<div>
									...
									<div class="col-6">
										<div class="row">
											...
											<div class="col-md-6 col-8">
												<div class="form-group">
													<div>
														<select id="product_group_name" name="product_group_name" data-placeholder="Product Group"
									...
									<div class="col-md-6">
										<div class="row">
											...
											<div class="col-md-6 col-6">
												<div class="form-group"><input id="amount" name="amount" type="text" class="form-control"
														value="<?php echo $_GET['amount']; ?>"></div>
											</div>
										</div>
									</div>
									...
									<div class="col-12 row justify-content-center mt-5">
											<div class="col-md-2"><button type="button" class="btn btn-block btn-lg btn-outline-danger"><span
														class="en">Exit</span><span class="ar">
														<?= getArabicTitle('Exit') ?>
													</span>
												</button>
											</div>
											<div class="col-md-2">
												<button type="submit" class="btn btn-block btn-lg btn-outline-success" id="seles_report_search"><span
														class="en">Search</span><span class="ar"><?= getArabicTitle('Search') ?></span>
												</button>
										</div>
									</div>
								</div>
...
//////////////// Branches Filter//////////////
										...
										include("include/reports/sales/sales_group/index.php");
