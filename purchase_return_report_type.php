		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row wrapper border-bottom white-bg page-heading pb-2">
					<div class="col-lg-10">
						<h2 class="font-weight-bold en float-left">Purchase Return Report Types</h2>
						<h2 class="font-weight-bold ar float-right"><?= getArabicTitle('Purchase Return Report Types') ?></h2>
					</div>
				</div>
				<div class="row mb-1">
