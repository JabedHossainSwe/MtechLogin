	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-12">
					<h2 class="font-weight-bold"><span class="float-left en">Product Transfer And Receive Report</span><span class="float-right ar"><?= getArabicTitle('Product Transfer And Receive Report') ?></span></h2>
				</div>
			</div>
			<div class="wrapper wrapper-content animated fadeInRight">
							...
							<form action="" id="" method="get" class="ibox-content filter_container">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="row">
											<div class="col-md-5">
												<h4><span class="en">Bill No. From</span><span class="ar"><?= getArabicTitle('Bill No. From') ?>
													</span></h4>
											</div>
											<div class="col-md-7">
												<div class="form-group">
													<input value="<?php echo $_GET['BillNoFrom']; ?>" id="BillNoFrom" name="BillNoFrom" type="text" class="form-control">
									...
									<div class="col-md-4">
										<div class="row">
											<div class="col-md-5">
												<h4><span class="en">Bill No. To</span><span class="ar"><?= getArabicTitle('Bill No. To') ?>
													</span></h4>
											</div>
											<div class="col-md-7">
												<div class="form-group">
													<input value="<?php echo $_GET['BillNoTo']; ?>" id="BillNoTo" name="BillNoFrom" type="text" class="form-control">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-md-4">
												<h4><span class="en">Users</span><span class="ar"><?= getArabicTitle('Users') ?></span></h4>
											</div>
											<div class="col-md-8">
												<select class="form-control" id="users" name="users" aria-label="sales-men">
													<?php
									...
									<div class="col-md-3">
										<div class="row">
											<div class="col-md-5">
												<h4><span class="en">Bill From Date</span><span class="ar"><?= getArabicTitle('Bill From Date') ?>
													') ?></span></h4>
											</div>
											<div class="col-md-7">
												<div class="form-group">
									...
									<div class="col-md-3">
										<div class="row">
											<div class="col-md-5">
												<h4><span class="en">Bill Date To</span><span class="ar"><?= getArabicTitle('Bill Date To') ?>
													</span> </h4>
											</div>
											<div class="col-md-7">
												<div class="form-group">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-md-4">
												<h4><span class="en">Item Group</span><span class="ar"><?= getArabicTitle('Item Group') ?>
													</span></h4>
											</div>
											...
											<div class="col-md-8 col-8">
												<div class="form-group">
													<div>
														<select id="product_group_name" name="Gids[]" data-placeholder="Product Group" class="select2_demo_1 form-control" multiple>
															<?php
									...
									<div class="col-3">
										<div class="row">
											<div class="col-md-5">
												<h4><span class="en">Item Code From</span><span class="ar"><?= getArabicTitle('Item Code From') ?>
													</span></h4>
											</div>

											<div class="col-md-7 col-8">
												<div class="form-group">
													<input id="FItemCode" name="FItemCode" type="hidden" class="form-control" value="<?php echo $_GET['FItemCode'] ?>" readonly>
													<div>
														<select id="from_item_name" name="from_item_name" class="select2_demo_1 form-control" tabindex="4" onChange="setmyValue(this.value,'FItemCode')">
															<?php
									...
									<div class="col-3">
										<div class="row">
											<div class="col-md-5">
												<h4><span class="en">Item Code To</span><span class="ar"><?= getArabicTitle('Item Code To') ?>
													</span></h4>
											</div>

											<div class="col-md-7 col-8">
												<div class="form-group">
													<input id="FItemCode" name="TItemCode" type="hidden" class="form-control" value="<?php echo $_GET['FItemCode'] ?>" readonly>
													<div>
														<select id="to_item_name" name="to_item_name" class="select2_demo_1 form-control" tabindex="4" onChange="setmyValue(this.value,'FItemCode')">
															<?php
															if (isset($_GET['FItemCode']) && !empty($_GET['FItemCode'])) {
															?>
																<option value="<?php echo $_GET['FItemCode']; ?>" selected> <?php echo getProductDetails($_GET['FItemCode'])->CName; ?> -
									...
									<div class="col-6">
										<div class="row">
											<div class="col-md-2">
												<h4><span class="en">From Branch</span><span class="ar"><?= getArabicTitle('From Branch') ?>
													</span></h4>
											</div>
											<div class="col-md-2">
												<div class="form-group">
				...
				?>
					<div class="ibox">
						<h2 class="float-left en">Product Stock Report</h2>
						<h2 class="float-left en"><?= getArabicTitle('Product Stock Report') ?></h2>
...
<script src="include/reports/product_transfer/js.js"></script>
<?php
if (isset($_GET['report_type']) && $_GET['report_type'] == 'general') {
?>
	<script>
