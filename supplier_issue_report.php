		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row wrapper border-bottom white-bg page-heading pb-2">
					<!-- <div class="col-lg-10"> -->
						<h2 class="font-weight-bold"><span class="en">Supplier Payment Report</span><span class="ar"><?= getArabicTitle('Supplier Payment Report') ?></span></h2>
					<!-- </div> -->
				</div>
				<div class="wrapper wrapper-content animated fadeInRight">
					<div class="row mb-3">
						...
						<div class="col-lg-12">
							<div class="ibox">
								<div class="ibox-title">
									<div class="row">
										<div class="col-md-12">
											<h5 class="mr-4 en float-left">Filters</h5>
											<h5 class="mr-4 ar float-right"><?= getArabicTitle('Filters') ?></h5>
										</div>
								...
								<form action="" id="" method="get" class="ibox-content filter_container">
									...
									<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-2">
													<div class="form-group">
														...
														<input type="checkbox" id="supplier_all_select" name="supplier_all_select" <?php if ($_GET['supplier_all_select'] == 'on') {echo "checked='checked' ";} ?> class="js-switch" />
													</div>
												</div>
												<div class="col-7">
													<div class="form-group">
														<div id="">
															<select id="SpName" name="SpName[]" class="select2_demo_1 form-control" multiple <?php if ($_GET['supplier_all_select'] == 'on') {echo "disabled";} ?>>
																<?php
														...
														<div class="col-md-4 col-6">
															<div class="i-checks"><label class="">
																	<div class="iradio_square-green ">
																		...
																		<ins class="iCheck-helper"></ins>
																	</div> <i></i> <span class="en">Group By Supplier</span><span class="ar"><?= getArabicTitle('Group By Supplier') ?></span>
																</label>
															</div>
														</div>
														<div class="col-md-4 col-6">
															<div class="i-checks"><label class="">
																	<div class="iradio_square-green ">
																		...
																		<ins class="iCheck-helper"></ins>
																	</div> <i></i> <span class="en">Group by BillDate </span><span class="ar"><?= getArabicTitle('Group by BillDate') ?></span>
																</label>
															</div>
														</div>
										...
										<div class="col-12 row justify-content-center mt-5">
											<div class="col-md-2"><button type="button" class="btn btn-block btn-lg btn-outline-danger" onClick="location.reload()"><span class="en">Exit</span><span class="ar"><?= getArabicTitle('Exit') ?></span>
												</button>
											</div>
											<div class="col-md-2">
					...
					?>
						<div class="ibox">
							<h2 class="en float-left">Supplier Payment Report</h2>
							<h2 class="ar float-right"><?= getArabicTitle('Supplier Payment Report') ?></h2>
								...
								<div class="table-responsive">
									...
									<div class="row">
										<div class="col-lg-12" id="sales_report">
											...
											$FBillno = !empty($_GET['from_bill_no']) ? $_GET['from_bill_no'] : NULL;
											$TBillno = !empty($_GET['to_bill_no']) ? $_GET['to_bill_no'] : NULL;
											...
											$mainStoreProcedure = "EXEC  " . dbObject . "GetSupplierPayments   @bid='" . $bid . "',@dt='" . $dt . "',@dt2='" . $dt2 . "',@CustSupId='" . $CustSupId . "',@LanguageId ='" . $LanguageId . "',@FBillno ='" . $FBillno . "',@TBillno ='" . $TBillno . "',@UsrId ='" . $UsrId . "',@GroupByType ='" . $GroupByType . "'";
											...
											///// Main Query/////
											$mainStoreProcedure . $DataType . $initialLimit;
											...
											if($_GET['GroupByType'] == 0){
												$pLink = 'SupplierIssueReportNone';
											}
											elseif($_GET['GroupByType'] == 1){
												$pLink = 'SupplierIssueReportSupplier';
											}
											elseif($_GET['GroupByType'] == 2){
												$pLink = 'SupplierIssueReportDate';
											}
											...
											<div class="col-md-12 col-sm-12 col-lg-12 mb-4 text-center">
												<div class="d-grid gap-2 col-12 pl-0">
													<button style="width: 130px;" type="button" class="btn btn-w-m btn-outline-primary" id="reportPRint" onclick="PrintPopup('<?= $print ?>', 'Supplier Payment Report', '<?= $pLink ?>')"><i class="fa fa-print" aria-hidden="true"></i></button>
												</div>
											</div>
											<hr>
											<!-- Listing -->
