	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Vat Detail Report</span><span class="ar"><?= getArabicTitle('Vat Detail Report') ?></span></h2>
				</div>
											...
											<div class="col-md-12 col-12">
												<div class="i-checks"><label class="">
														<div class="iradio_square-green ">
															<div class="iradio_square-green">
																<input type="radio" <?php if ($_GET['noVat'] == '1') {echo "Checked";} ?> value="1" name="noVat">
															</div>
															<ins class="iCheck-helper"></ins>
														</div> <i></i> <span class="en">Is With No Vat </span><span class="ar">
															<?= getArabicTitle('Is With No Vat') ?>
														</span>
													</label>
												</div>
											</div>
							...
							<div class="table-responsive">
								...
								<div class="row">
									<div class="col-lg-12" id="sales_report">
										...
										if (isset($_GET['noVat']) && !empty($_GET['noVat'])) {
											$noVat = urldecode($_GET['noVat']);
										}
										...
										$noVat = !empty($noVat) ? $noVat : 0;

										$pages = new Paginator;

										include("include/reports/vat/vat_detail_report/index.php");
