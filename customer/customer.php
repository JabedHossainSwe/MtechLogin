                          ...
                          ?>
                            <tr>
                              <td colspan="4" class="text-center">
                                <h2><strong><span class="en float-left">No Record(s)Found..</span><span
                                      class="ar float-right">..
                                      <?= getArabicTitle('No Record(s)Found') ?>
                                    </span></strong></h2>
                              </td>
                            </tr>
                            <?php
