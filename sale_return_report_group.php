	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Sales Return Report (Group) </span><span class="ar"><?= getArabicTitle('Sales Return Report (Group) ') ?></span></h2>
				</div>
				<div class="col-lg-2">
									...
									<div class="col-12 row justify-content-center mt-5">
										...
										<div class="col-md-2">
											<button type="submit" class="btn btn-block btn-lg btn-outline-success"
												id="seles_report_search"><span class="en">Search</span><span class="ar">
