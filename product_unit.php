	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-12">
					<h2 class="font-weight-bold en float-left">Product Unit</h2>
					<h2 class="font-weight-bold ar float-right"><?= getArabicTitle('Product Unit') ?></h2>
				</div>
			</div>
...
<script src="include/product_unit/js.js"></script>
