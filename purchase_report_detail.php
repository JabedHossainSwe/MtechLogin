	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Purchase Report (Detail)</span><span class="ar"><?= getArabicTitle('Purchase Report (Detail)') ?></span></h2>
				</div>
				<div class="col-lg-2">
										...
										<div class="row">
											...
											<div class="col-md-2 col-4">
												<div class="form-group"><input id="PurChaser" name="PurChaser" type="text" readonly
														class="form-control" value="<?php echo $_GET['PurChaser'] ?>"></div>
											</div>
											<div class="col-md-6 col-8">
												<div class="form-group">
													<div>
...
//////////////// Branches Filter//////////////
										...
										if ($_GET['GroupByType'] == '') {
											...
											include("include/reports/purchase/purchase_detail/groupbynone.php");
										}
										...
										if ($_GET['GroupByType'] == '1') {
											...
											include("include/reports/purchase/purchase_detail/groupbyproduct.php");
										}
