	...
	<div id="wrapper" class="direction">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading pb-2">
				<div class="col-lg-4">
					<h2 class="font-weight-bold"><span class="en">Purchase Return Report (Detail)</span><span class="ar"><?= getArabicTitle('Purchase Return Report (Detail)') ?></span></h2>
				</div>
				<div class="col-lg-2">
...
//////////////// Branches Filter//////////////
										...
										if ($_GET['GroupByType'] == '') {
											$GroupByType = 0;
											$OrderBy = 'Billno';
											include("include/reports/purchase/purchase_return_detail/groupbynone.php");
										}
										...
										if ($_GET['GroupByType'] == '1') {
											...
											include("include/reports/purchase/purchase_return_detail/groupbyproduct.php");
										}
