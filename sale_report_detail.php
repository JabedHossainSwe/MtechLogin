...
<div class="col-lg-4">
<h2 class="font-weight-bold"><span class="en">Sales Report (Detail)</span><span class="ar"><?= getArabicTitle('Sales Report (Detail)') ?></span></h2>
</div>
<div class="col-lg-2">
<a href="sale_report_general.php">
<div style="padding: 12px 20px!important;background: #7de9d3 !important; color: black;" class="widget style1 ">
...
<div class="col-12">
<button type="button" class="btn btn-w-m btn-outline-primary float-right" id="filter"><span class="en">Filters</span><span class="ar"><?= getArabicTitle('Filters') ?></span></h4></button>
</div>
...
<input type="checkbox" id="branch_all_select" name="branch_all_select" <?php if ($_GET['branch_all_select'] == 'on') {echo "checked";} ?> class="js-switch" />
</div>
</div>
<div class="col-md-8">
<div class="form-group">
<div>
<select id="branchs" name="branch[]" class="select2_demo_1 form-control" tabindex="4" multiple>
<?php
...
<div class="form-group"><input id="customer_id" name="customer_id" type="text" class="form-control" value="<?php echo $_GET['customer_id'] ?>"></div>
</div>
<div class="col-md-6 col-8">
<div class="form-group">
<div>
...
<div class="col-md-2 col-4">
<div class="form-group"><input id="from_product_id" name="from_product_id" type="text" class="form-control" value="<?php echo $_GET['from_product_id'] ?>" readonly></div>
</div>
<div class="col-md-6 col-8">
<div class="form-group">
<div>
...
<div class="col-md-2 col-4">
<div class="form-group"><input id="to_product_id" name="to_product_id" type="text" class="form-control" readonly value="<?php echo $_GET['to_product_id'] ?>"></div>
</div>
<div class="col-md-6 col-8">
<div class="form-group">
<div>
...
<div class="col-md-2 col-4">
<div class="form-group"><input id="product_group_id" name="product_group_id" type="text" class="form-control" value="<?php echo $_GET['product_group_id'] ?>"></div>
</div>
<div class="col-md-6 col-8">
<div class="form-group">
<div>
...
<select id="product_group_name" name="product_group_name" data-placeholder="<?= $placeholder ?>" class="select2_demo_1 form-control" onChange="setmyValue(this.value,'product_group_id')">
<?php
...
<div class="row">
<div class="col-md-4">
<h4><span class="en">Amount</span><span class="ar">
<?= getArabicTitle('Amount') ?>
</span> </h4>
</div>
<div class="col-md-2 col-6">
<div class="form-group">
<select name="amount_type" id="amount_type" class="form-control">
<option value="=" <?php if ($_GET['amount_type'] == '=') {
echo "Selected";
} ?>> = </option>
<option value=">" <?php if ($_GET['amount_type'] == '>') {
echo "Selected";
...
<div class="form-group"><input id="amount" name="amount" type="text" class="form-control" value="<?php echo $_GET['amount']; ?>"></div>
</div>
</div>
</div>
...
<div class="iradio_square-green ">
<div class="iradio_square-green">
<input type="radio" value="BillDateTime" name="OrderBy" <?php if ($_GET['OrderBy'] == 'BillDateTime' || $_GET['OrderBy'] == '') {
	echo 'checked="checked"';
} ?>>
</div>
<ins class="iCheck-helper"></ins>
...
<div class="iradio_square-green ">
<div class="iradio_square-green">
<input type="radio" value="product" name="GroupByType" <?php if ($_GET['GroupByType'] == 'product') {
	echo "Checked";
} ?>>
</div>
<ins class="iCheck-helper"></ins>
</div> <i></i> <span class="en">Group by Product </span><span class="ar">
<?= getArabicTitle('Group by Product') ?>
</span>
</label>
</div>
</div>
...
<div class="col-md-2"><button type="button" class="btn btn-block btn-lg btn-outline-danger"><span class="en">Exit</span><span class="ar">
<?= getArabicTitle('Exit') ?>
</span>
</button>
</div>
<div class="col-md-2">
<button type="submit" class="btn btn-block btn-lg btn-outline-success" id="seles_report_search"><span class="en">Search</span><span class="ar">
...
?>
<div class="ibox">
<h2 class="en float-left">Detail</h2>
<h2 class="ar float-right"><?= getArabicTitle('Detail') ?></h2>
...
$GroupByType = !empty($GroupByType) ? $dataGroupByType : '0';
...
$PGroupId = !empty($PGroupId) ? $PGroupId : '0';
$CrAmount = !empty($CrAmount) ? $CrAmount : '0';
$LanguageId = $_GET['selected_lang'];

$LanguageId = !empty($LanguageId) ? $LanguageId : '1';
$amount_type = !empty($amount_type) ? $amount_type : '>';
...
if ($_GET['GroupByType'] == '') {
include("include/reports/sales/sales_detail/groupbynone.php");
}

if ($_GET['GroupByType'] != '') {
$GroupByType = "1";
$OrderBy = '';
include("include/reports/sales/sales_detail/groupbyproduct.php");
}
